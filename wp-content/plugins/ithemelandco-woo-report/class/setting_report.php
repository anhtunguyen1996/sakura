...
$it_report_metaboxname_fields_options_general_setting = array(
	array(
		'label'	=> esc_html__('System Settings',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> "",
	...
	array(
		'label'	=> esc_html__('Shop Order Status',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> esc_html__('Set default shop order status, Selected status will be used for calculating salse amount. Default statuses : completed, on-hold and processing',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
	...
	array(
		'label'	=> esc_html__('Hide Trash Order',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> esc_html__('Yes, Please',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'name'  => __IT_REPORT_WCREPORT_FIELDS_PERFIX__.'otder_status_hide',
		'id'    => __IT_REPORT_WCREPORT_FIELDS_PERFIX__.'otder_status_hide',
		'type'	=>'checkbox',
	),
	array(
		'label'	=> esc_html__('Invoice Logo',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> esc_html__('Upload an image as Invoice Pdf logo',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'name'  => __IT_REPORT_WCREPORT_FIELDS_PERFIX__.'invoice_logo',
		'id'    => __IT_REPORT_WCREPORT_FIELDS_PERFIX__.'invoice_logo',
		'type'	=>'upload',
	),
	array(
		'label'	=> esc_html__('Invoice Footer Text',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> esc_html__('Set footer text for invoice pdf',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'name'  => __IT_REPORT_WCREPORT_FIELDS_PERFIX__.'invoice_footer_text',
		'id'    => __IT_REPORT_WCREPORT_FIELDS_PERFIX__.'invoice_footer_text',
		'type'	=>'text',
	),
	array(
		'label'	=> esc_html__('Close Search Automatically',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> esc_html__('Yes, Please. Yes, Please. If checked, the search form will be closed automatically after submission',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'name'  => __IT_REPORT_WCREPORT_FIELDS_PERFIX__.'close_search',
		'id'    => __IT_REPORT_WCREPORT_FIELDS_PERFIX__.'close_search',
		'type'	=>'checkbox',
	),
	array(
		'label'	=> esc_html__('Dashboard Setting',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> "",
	...
	array(
		'label'	=> esc_html__('Dashboard Status',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> esc_html__('You can enable/disable dashboard and set another report as default report',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'name'  => __IT_REPORT_WCREPORT_FIELDS_PERFIX__.'dashboard_status',
		'id'    => __IT_REPORT_WCREPORT_FIELDS_PERFIX__.'dashboard_status',
		'type'	=>'select',
		'options'	=>array(
			'one' => array(
				'label' => esc_html__('Enable, please',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
				'value' => 'true',
			),
			'two' => array(
				'label' => esc_html__('Disable, please',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
				'value' => 'false',
			),
		),
	),
	// array(
	// 	'label'	=> esc_html__('Alternative Report',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
	// 	'desc'	=> esc_html__('Choose which one of reports that you want to display insted dashboard',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
	...
	// ),
	array(
		'label'	=> esc_html__('Dashboard Date',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> esc_html__('Do you want to set customize date for dashboard search ?',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'name'  => __IT_REPORT_WCREPORT_FIELDS_PERFIX__.'customize_date',
		'id'    => __IT_REPORT_WCREPORT_FIELDS_PERFIX__.'customize_date',
		'type'	=>'select',
		'options'	=>array(
			'one' => array(
				'label' => esc_html__('No, I want use default date',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
				'value' => 'false',
			),
			'two' => array(
				'label' => esc_html__('Yes, please',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
				'value' => 'true',
			),
		),
		'dependency' => array(
	...
	array(
		'label'	=> esc_html__('From Date',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> esc_html__('Set from date for dashboard search',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
	...
	array(
		'label'	=> esc_html__('To Date',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> esc_html__('Set to date for dashboard search',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
	...
	// array(
	// 	'label'	=> esc_html__('Disable Map in Dashboard ?',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
	// 	'desc'	=> esc_html__('Yes, Please',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
	...
	// ),
	array(
		'label'	=> esc_html__('Disable Charts in Dashboard ?',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> esc_html__('Yes, Please',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
	...
	array(
		'label'	=> esc_html__('Dashboard Box Count',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> "",
		'name'	=> __IT_REPORT_WCREPORT_FIELDS_PERFIX__.'set_default_search',
		'id'	=> __IT_REPORT_WCREPORT_FIELDS_PERFIX__.'set_default_search',
		'type'	=> 'notype',
	...
	array(
		'label'	=> esc_html__('Recent Order',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> esc_html__('Set Minimum page number for Recent Order table',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
	...
	array(
		'label'	=> esc_html__('Top Product',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> esc_html__('Set Minimum page number for Top Product table',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
	...
	array(
		'label'	=> esc_html__('Top Category',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> esc_html__('Set Minimum page number for Top Category table',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
	...
	array(
		'label'	=> esc_html__('Top Customer',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> esc_html__('Set Minimum page number for Top Customer table',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
	...
	array(
		'label'	=> esc_html__('Top Billing Country',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> esc_html__('Set Minimum page number for Top Billing Country table',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
	...
	array(
		'label'	=> esc_html__('Top State Country',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> esc_html__('Set Minimum page number for Top State Country table',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
	...
	array(
		'label'	=> esc_html__('Top Payment Gateway',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> esc_html__('Set Minimum page number for Top Payment Gateway table',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
	...
	array(
		'label'	=> esc_html__('Top Coupon',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> esc_html__('Set Minimum page number for Top Coupon table',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
...
if(is_array(__CUSTOMWORK_ID__) && in_array('12679',__CUSTOMWORK_ID__)){
	$extra_cols=array();
	$extra_cols[]= array(
		'label'	=> esc_html__('Clinic Type',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> esc_html__('Set default shop order status, Selected status will be used for calculating salse amount. Default statuses : completed, on-hold and processing',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
...
$it_report_metaboxname_fields_options_email_setting = array(
	...
	array(
		'label'	=> '<span style="color:#d97c7c">'.esc_html__('Automatic Email (Available in PRO Version)',__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</span>',
		'desc'	=> "",
	...
	array(
		'label'	=> esc_html__('Active Email Reporting',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> esc_html__('Yes, Please',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
	...
	array(
		'label'	=> esc_html__('Email Today Report',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> esc_html__('Yes, Please',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
	...
	array(
		'label'	=> esc_html__('Email Yesterday Report',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> esc_html__('Yes, Please',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
	...
	array(
		'label'	=> esc_html__('Email Current Week Report',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> esc_html__('Yes, Please',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
	...
	array(
		'label'	=> esc_html__('Email Last Week Report',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> esc_html__('Yes, Please',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
	...
	array(
		'label'	=> esc_html__('Email Current Month Report',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> esc_html__('Yes, Please',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
	...
	array(
		'label'	=> esc_html__('Email Last Month Report',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> esc_html__('Yes, Please',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
	...
	array(
		'label'	=> esc_html__('Email Current Year Report',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> esc_html__('Yes, Please',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
	...
	array(
		'label'	=> esc_html__('Email Last Year Report',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> esc_html__('Yes, Please',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
	...
	array(
		'label'	=> esc_html__('Email Till Today Report',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> esc_html__('Yes, Please',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
	...
	array(
		'label'	=> esc_html__('Email Total/Other/Today Summary Report',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> esc_html__('Yes, Please',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
	...
	//CUSOM WORK - 4061
	array(
		'label'	=> esc_html__('Email Purchased Product by Customer',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> esc_html__('Yes, Please',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
	...
	array(
		'label'	=> esc_html__('Email Send To',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> esc_html__('Set Receiver Email',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
	...
	array(
		'label'	=> esc_html__('From Name',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> esc_html__('Set Sender Name',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
	...
	array(
		'label'	=> esc_html__('From Email',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> esc_html__('Set Sender Email',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
	...
	array(
		'label'	=> esc_html__('Subject',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> esc_html__('Set Email Subject',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
	...
	array(
		'label'	=> esc_html__('Email Schedule',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> esc_html__('Set the email schedule',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'name'  => __IT_REPORT_WCREPORT_FIELDS_PERFIX__.'email_schedule',
		'id'    => __IT_REPORT_WCREPORT_FIELDS_PERFIX__.'email_schedule',
		'type'	=>'select',
		'options'	=>array(
			'00' => array(
				'label' => esc_html__('Select One',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
				'value' => '0',
			),
			'0' => array(
				'label' => esc_html__('Once Hourly',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
				'value' => 'it_schd_hourly',
			),
			'1' => array(
				'label' => esc_html__('Once Daily',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
				'value' => 'it_schd_daily',
			),
			'2' => array(
				'label' => esc_html__('Once Weekly',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
				'value' => 'it_schd_weekly',
			),
			'3' => array(
				'label' => esc_html__('Once Monthly',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
				'value' => 'it_schd_monthly',
			),
			'4' => array(
				'label' => esc_html__('Twice Hourly',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
				'value' => 'it_schd_twicehourly',
			),
			'5' => array(
				'label' => esc_html__('Twice Daily',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
				'value' => 'it_schd_twicedaily',
			),
			'6' => array(
				'label' => esc_html__('Twice Weekly',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
	...
	array(
		'label'	=> esc_html__('Optimize Email Format',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> esc_html__('Check this fields, if your email is unformatted.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
...
if(defined("__IT_BRANDS_ADD_ON__")){
	$it_brands_fields=array(
		array(
			'label'	=> '<span style="color:#d97c7c">'.esc_html__("Brands Add-ons (Available in PRO Version)",__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</span>',
			'desc'	=> esc_html__("Set the Brands add-ons settings.",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
			'name'	=> __IT_REPORT_WCREPORT_FIELDS_PERFIX__.'set_brands_addons',
			'id'	=> __IT_REPORT_WCREPORT_FIELDS_PERFIX__.'set_brands_addons',
			'type'	=> 'notype',
		),
		array(
			'label'	=> esc_html__('Enable Brand Taxonomy',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
			'desc'	=> esc_html__('Do you want to enable brand taxonomy ?',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
			'name'  => __IT_REPORT_WCREPORT_FIELDS_PERFIX__.'enable_brand',
			'id'    => __IT_REPORT_WCREPORT_FIELDS_PERFIX__.'enable_brand',
			'type'	=>'select',
			'options'	=>array(
				'1' => array(
					'label' => esc_html__('No, at all',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
					'value' => 'no',
				),
				'2' => array(
					'label' => esc_html__('Yes, I want use iThemelandCo Plugin',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
					'value' => 'yes_this',
				),
				'3' => array(
					'label' => esc_html__('Yes, I have Brands plugin',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
					'value' => 'yes_another',
				),
		...
		array(
			'label'	=> esc_html__('Plugin',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
			'desc'	=> esc_html__('Choose your "Brands" plugin name.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
			'name'  => __IT_REPORT_WCREPORT_FIELDS_PERFIX__.'brands_plugin',
			'id'    => __IT_REPORT_WCREPORT_FIELDS_PERFIX__.'brands_plugin',
			'type'	=>'select',
			'options'	=>array(
				'1' => array(
					'label' => esc_html__('WooCommerce Brands By Woothemes',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
					'value' => 'product_brand',
				),
				'2' => array(
					'label' => esc_html__('Ultimate WooCommerce Brands Plugin',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
					'value' => 'product_brand',
				),
				'3' => array(
					'label' => esc_html__('YITH WOOCOMMERCE BRANDS ADD-ON',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
					'value' => 'yith_product_brand',
				),
				'4' => array(
					'label' => esc_html__('Proword WooCommerce Brand',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
					'value' => 'product_brand',
				),
				'5' => array(
					'label' => esc_html__('Other Plugin',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
					'value' => 'other',
				),
			),
			'dependency' => array(
		...
		array(
			'label'	=> esc_html__('Taxonomy Slug',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
			'desc'	=> __('Set the taxonomy slug plugin. <br /><strong>E.g: </strong>WooCommerce Brands by Woothemes : product_brand ',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		...
		array(
			'label'	=> esc_html__('Brand Label',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
			'desc'	=> esc_html__('Set brand label.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		...
		array(
			'label'	=> esc_html__('Brand Thumnail',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
			'desc'	=> esc_html__('Show brands as thumbnail in grid column.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
...
if(defined("__IT_PO_ADD_ON__") && defined("THEMECOMPLETE_EPO_VERSION")) {
	$product_options_fields=array(
		...
		/// PRODUCT OPTIONS CUSTOM FIELDS
		array(
			'label'	=> esc_html__("Product Options Plugin",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
			'desc'	=> esc_html__("You can add fields generated by Product Options Plugin to Some Reports",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		...
		array(
			'label' => '',
			'desc'  => esc_html__('Select your custom fields for serach query, This fields just will be displayed in All Orders Reort (Based on Taxonomies)',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
			'id'    => __IT_REPORT_WCREPORT_FIELDS_PERFIX__.'po_custom_fields',
			'name'    => __IT_REPORT_WCREPORT_FIELDS_PERFIX__.'po_custom_fields',
			'type'  => 'tab_multi_side',
		),
		array(
			'label'	=> esc_html__("Checkout Options Plugin",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
			'desc'	=> esc_html__("You can add fields generated by Checkout Options Plugin to Some Reports",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
...
if(defined("__IT_TAX_FIELD_ADD_ON__")) {
	$custom_tax_fields=array(
		array(
			'label'	=> esc_html__("Custom Taxonomy & Fields",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
			'desc'	=> esc_html__("In this section you can choose which WooCommerce Taxonomy and which Custom fields appear in Report.",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
			'name'	=> __IT_REPORT_WCREPORT_FIELDS_PERFIX__.'set_default_search',
			'id'	=> __IT_REPORT_WCREPORT_FIELDS_PERFIX__.'set_default_search',
			'type'	=> 'notype',
		),
		array(
			'label'	=> esc_html__('Custom Taxonmy',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
			'desc'	=> "",
			'name'	=> __IT_REPORT_WCREPORT_FIELDS_PERFIX__.'set_default_search',
			'id'	=> __IT_REPORT_WCREPORT_FIELDS_PERFIX__.'set_default_search',
		...
		array(
			'label' => esc_html__('Custom Fields',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
			'desc'  => esc_html__('Select your custom fields for serach query, This fields just will be displayed in All Orders Reort (Based on Taxonomies)',__IT_REPORT_WCREPORT_TEXTDOMAIN__).'<br />'.esc_html__('<strong>Note : </strong> Individual fields are used for specific products , so you can set to display them in data table only, Not as filter.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
...
if(defined("__IT_INT_REPORTS_ADD_ON__")) {
	$custom_int_fields=array(
		...
		array(
			'label'	=> esc_html__("Recency Points",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
			'desc'	=> esc_html__("How recently did the customer purchase?",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		...
		array(
			'label'	=> esc_html__("Frequency Points",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
			'desc'	=> esc_html__("How often do they purchase?",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		...
		array(
			'label'	=> esc_html__("Monetary Value",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
			'desc'	=> esc_html__("How much do they spend?",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
...
if(defined("__IT_TICKERA_ADD_ON__")) {
	$tickera_fields=array(
		array(
			'label'	=> esc_html__("Tickera Plugin",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
			'desc'	=> esc_html__("You can add fields generated by Tickera Plugin to Some Reports",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		...
		array(
			'label' => '',
			'desc'  => esc_html__('Select your custom fields for serach query, This fields just will be displayed in All Orders Reort.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
...
//		array(
//			'label'	=> esc_html__("Currency Switcher - Multiple Currency",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
//			'desc'	=> '',
//			'name'	=> __IT_REPORT_WCREPORT_FIELDS_PERFIX__.'set_default_search',
//			'id'	=> __IT_REPORT_WCREPORT_FIELDS_PERFIX__.'set_default_search',
//			'type'	=> 'notype',
//		),
//		array(
//			'label'	=> esc_html__('Enable Currency Swither',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
//			'desc'	=> esc_html__('If you have "WooCommerce Currency Switcher" plugin, You price will be convert to your admin currency',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
...
//		),
	...
	//COST OF GOOD
	// array(
	// 	'label'	=> esc_html__('Cost of Good',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
	// 	'desc'	=> "",
	...
	// ),
	array(
		'label'	=> esc_html__('Enable Field',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> esc_html__('Do you want to enable custom field of cost of god ?',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		...
		'options'	=>array(
			...
			'two' => array(
				'label' => esc_html__('Yes, I have Cost of Good plugin',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
				'value' => 'yes_another',
			),
//				'three' => array(
//					'label' => esc_html__('Yes, I want use this Cost of Good',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
//					'value' => 'yes_this',
//				),
		)
	),
	...
	array(
		'label'	=> esc_html__('Plugin',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> esc_html__('Choose your "Cost of Goods/Profit" plugin name.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'name'  => __IT_REPORT_WCREPORT_FIELDS_PERFIX__.'cog_plugin',
		'id'    => __IT_REPORT_WCREPORT_FIELDS_PERFIX__.'cog_plugin',
		'type'	=>'select',
		'options'	=>array(
			'one' => array(
				'label' => esc_html__('WooCommerce Cost of Goods by Woothemes',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
				'value' => 'woo_profit',
			),
			'two' => array(
				'label' => esc_html__('WooCommerce Profit of Sales Report by IndoWebKreasi',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
				'value' => 'indo_profit',
			),
//				'three' => array(
//					'label' => esc_html__('Other Plugin',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
...
//				),
	...
	array(
		'label'	=> esc_html__('Custom field 1',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> __('Set the custom field of plugin. <br /><strong>e.g: </strong>WooCommerce Cost of Goods by Woothemes : _wc_cog_cost <br />WooCommerce Profit of Sales Report by IndoWebKreasi : _posr_cost_of_good',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
	...
	array(
		'label'	=> esc_html__('Custom field 2',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> __('Set the total custom field of plugin. <br /><strong>e.g: </strong>WooCommerce Cost of Goods by Woothemes : _wc_cog_item_total_cost  <br />WooCommerce Profit of Sales Report by IndoWebKreasi : _posr_line_cog_total',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
...
$it_report_metaboxname_fields_options_projected= array(
	array(
		'label'	=> '<span style="color:#d97c7c">'.esc_html__('Project Sale (Available in PRO Version)',__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</span>',
		'desc'	=> "",
		'name'	=> __IT_REPORT_WCREPORT_FIELDS_PERFIX__.'set_default_search',
		'id'	=> __IT_REPORT_WCREPORT_FIELDS_PERFIX__.'set_default_search',
		'type'	=> 'notype',
	...
	array(
		'label' => esc_html__('Projected Sales Year',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'  => esc_html__('Choose Year',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
	...
	array(
		'label'	=> esc_html__("Set Sales of monthes",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> "",
...
$it_report_metaboxname_fields_options_translate= array(
	array(
		'label'	=> esc_html__("Set Your Translate(s)",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> "",
	...
	array(
		'label'	=> esc_html__("Set Translate for January",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> "",
	...
	array(
		'label'	=> esc_html__("Set Translate for February",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> "",
	...
	array(
		'label'	=> esc_html__("Set Translate for March",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> "",
	...
	array(
		'label'	=> esc_html__("Set Translate for April",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> "",
	...
	array(
		'label'	=> esc_html__("Set Translate for May",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> "",
	...
	array(
		'label'	=> esc_html__("Set Translate for June",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> "",
	...
	array(
		'label'	=> esc_html__("Set Translate for July",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> "",
	...
	array(
		'label'	=> esc_html__("Set Translate for August",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> "",
	...
	array(
		'label'	=> esc_html__("Set Translate for September",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> "",
	...
	array(
		'label'	=> esc_html__("Set Translate for October",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> "",
	...
	array(
		'label'	=> esc_html__("Set Translate for November",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> "",
	...
	array(
		'label'	=> esc_html__("Set Translate for December",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> "",
...
$it_report_metaboxname_fields_options_license= array(
	array(
		'label'	=> esc_html__("Customization",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> "",
	...
	array(
		'label'	=> esc_html__("Set Your Custom Work ID",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
		'desc'	=> esc_html__("Set Your Custom Work ID if You Ordered the Custom Work.",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
...
//	print_r($_POST);
    ...
    <div id="setting-error-settings_updated" class="updated settings-error">
        <p><strong><?php echo esc_html__('Settings saved',__IT_REPORT_WCREPORT_TEXTDOMAIN__);?>.</strong></p>
    </div>
	<?php
}
            ...
            <div class="row">
			    ...
			    <div class="awr-box">
			         <div class="awr-title">
                        <h3>
                            <i class="fa fa-cog"></i>
                        '.esc_html__('Woo Report Settings',__IT_REPORT_WCREPORT_TEXTDOMAIN__).'
                        </h3>
...
foreach($it_report_options_part as $option_part){
	...
	foreach ($this_part_variable as $field) {
		...
		switch($field['type']) {
			...
			case 'link':
				$html.= '<a class="button-primary" href="'.$field['href'].'" id="'.$field['id'].'" ><i class="fa fa-envelope-o"></i>'.esc_html__('Click Here',__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</a>
<div class="email_target"></div>
			...
			case 'order_status':
				...
				$html.='<option value="-1">'.esc_html__('Select All',__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</option>';
				$html.=$option;
				$html.='
							</select>
								<br /><span class="description">'.$field['desc'].'</span>';
			...
			case "custom_search_items":{
				$custom_tax_pages=array(
					array("details_tax_field" => esc_html__("Taxonomies All Order",__IT_REPORT_WCREPORT_TEXTDOMAIN__)),
					array("product" => esc_html__("Product",__IT_REPORT_WCREPORT_TEXTDOMAIN__)),
					array("variation_stock" => esc_html__("Variation Stock",__IT_REPORT_WCREPORT_TEXTDOMAIN__)),
				...
				foreach($custom_tax_pages as $tab){
					...
					foreach($tab as $key=>$value){
						...
						if(in_array($key,array("prod_per_month","prod_per_state","prod_per_country")) && !defined("__IT_CROSSTABB_ADD_ON__")){
							...
							$html.= '<h4><center><i class="fa fa-4x fa-user-times"></i><br />'.__("'CrossTab Add-on' is needed! Please Purchase/Active it. <br />click ",__IT_REPORT_WCREPORT_TEXTDOMAIN__)."<a target='_blank' href='".admin_url()."admin.php?page=wcx_wcreport_plugin_addons_report&parent=addons'>".esc_html__("Here",__IT_REPORT_WCREPORT_TEXTDOMAIN__)."</a>".esc_html__(" For more info !",__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</center></h4>';
							$html.='</div>';
							continue;
						}
							...
							foreach ( $all_tax as $tax ) {
								...
								$html .='
														<div class="full-lbl-cnt more-padding">
															...
															<input type="text" name="'.$key.'_'.$tax.'_translate" value="'.$translate.'"/><span class="description">'.esc_html__('Set Label, Leave blank to use from default label',__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</span>
														</div>
														<br />
														';
...
">'.$selected_options.'</select>
									<button type="button" id="translate_fields_tickera" class="btn btn-warning btn-block" style="background-color:#0DBF44;border-color: #06A036; border-radius: 4px; margin-top: 5px;">'.esc_html__('Field`s Settings',__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</button>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-md-12" style="margin-top: 20px;">
									<div class="awr-form-title" style="padding: 7px 5px 10px;text-align: center;background: #e0e0e0;color: #666;margin-bottom: 15px;">
										'.esc_html__('Field`s Settings',__IT_REPORT_WCREPORT_TEXTDOMAIN__).'
									</div>


									<div class="col-xs-12 it_awr_fields_translate_tickera">';

				//$operators=array("eq"=>esc_html__('EQUALS',__IT_REPORT_WCREPORT_TEXTDOMAIN__),);
					...
					foreach($meta as $opt){
						...
						$html.= '
                                        ...
                                        <div class="col-xs-12 pw-translate_tickera">
                                            ...
                                            <input type="checkbox" name="'.$id_field.'_column" placeholder="Label for '.$opt.'" "'.checked("on",$col,0).'">'.esc_html__("Display in Grid",__IT_REPORT_WCREPORT_TEXTDOMAIN__);
                                            $html.='
                                            <input type="hidden" name="'.$id_field.'_filter" placeholder="Label for '.$opt.'" value="off">
                                            <input type="checkbox" name="'.$id_field.'_filter" placeholder="Label for '.$opt.'" "'.checked("on",$filter,0).'">'.esc_html__("Display in Filter",__IT_REPORT_WCREPORT_TEXTDOMAIN__);
                                        $html.='
                                            <br />
        ...
        ';
			...
			case 'recency_numeric_int':
				...
				for($i=5;$i>0;$i--){
					...
					$title=($i).' '.esc_html__("Points - Less Than",__IT_REPORT_WCREPORT_TEXTDOMAIN__).' ';
					if($i==1)
						$title=($i).' '.esc_html__("Point &nbsp - Less Than",__IT_REPORT_WCREPORT_TEXTDOMAIN__).' ';

					$metas=isset($meta[$i])?$meta[$i]:"";

					$int_html.='
						        <label for="'.$field['id'].'['.$i.']" class="full-label">'.$title.'</label>
							    <input type="number" name="'.$field['id'].'['.$i.']"  id="'.$field['id'].'['.$i.']" value="'.($metas=='' ? "":$metas).'" size="30" class="width_170 '.$field['id'].'['.$i.']" min="0" pattern="[-+]?[0-9]*[.,]?[0-9]+" title="Only Digits!" class="input-text qty text" />&nbsp&nbsp '.esc_html__("Days",__IT_REPORT_WCREPORT_TEXTDOMAIN__).'<br />
						        ';
				}
			...
			case 'frequency_numeric_int':
				...
				for($i=5;$i>0;$i--){
					...
					$title=($i).' '.esc_html__("Points - More Than",__IT_REPORT_WCREPORT_TEXTDOMAIN__).' ';
					if($i==1)
						$title=($i).' '.esc_html__("Point &nbsp - More Than",__IT_REPORT_WCREPORT_TEXTDOMAIN__);
					$metas=isset($meta[$i])?$meta[$i]:"";

					$int_html.='
						        <label for="'.$field['id'].'['.$i.']" class="full-label">'.$title.'</label>
							    <input type="number" name="'.$field['id'].'['.$i.']"  id="'.$field['id'].'['.$i.']" value="'.($metas=='' ? "":$metas).'" size="30" class="width_170 '.$field['id'].'['.$i.']" min="0" pattern="[-+]?[0-9]*[.,]?[0-9]+" title="Only Digits!" class="input-text qty text" />&nbsp&nbsp '.esc_html__("Times",__IT_REPORT_WCREPORT_TEXTDOMAIN__).'<br />
						        ';
				}
			...
			case "it_pages":
				{
					$args = array(
						...
						'name'                  => $field['id'],
						'id'                    => null, // string
						'show_option_none'      => esc_html__('Choose a Page',__IT_REPORT_WCREPORT_TEXTDOMAIN__), // string
			...
			case 'posttype_seletc':
				{
					...
					$html.='<option value="" >'.esc_html__('Choose Post Type',__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</option>';
			...
			case 'all_search':
				{
					$html.='
							<select name="'.$field['name'].'" >
								<option value="">'.esc_html__('Choose Live Search',__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</option>';
			...
			case 'upload':
				//wp_enqueue_media();
				$image = __IT_REPORT_WCREPORT_URL__.'/assets/images/pw-transparent.gif';
				//$image='';
				...
				$html.= '<input name="'.$field['id'].'" id="'.$field['id'].'" type="hidden" class="custom_upload_image '.$field['id'].'" value="'.(isset($meta) ? $meta:'').'" />
							...
							<input name="btn" class="awr_upload_image_button button" type="button" value="'.esc_html__('Choose Image',__IT_REPORT_WCREPORT_TEXTDOMAIN__).'" />
			...
			case "default_archive_grid":
				{
					...
					$html.= '<select name="'.$field['id'].'" id="'.$field['id'].'" class="'.$field['id'].'" style="width: 170px;">
									<option>'.esc_html__('Choose Shorcode',__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</option>';
			...
			case "it_sendto_form_fields":
				{
					$html.= '
							<label class="it_showhide" for="displayProduct-price"><input name="'.$field['id'].'[name_from]" type="checkbox" '.(is_array($meta) && in_array("name_from",$meta) ? "CHECKED": "").' value="name_from" class="displayProduct-eneble">'.esc_html__('Name (From) Field',__IT_REPORT_WCREPORT_TEXTDOMAIN__).' </label>

							<label class="it_showhide" for="displayProduct-price"><input name="'.$field['id'].'[name_to]" type="checkbox" '.(is_array($meta) && in_array("name_to",$meta) ? "CHECKED": "").' value="name_to" class="displayProduct-eneble">'.esc_html__('Name (To) Field',__IT_REPORT_WCREPORT_TEXTDOMAIN__).' </label>

							<label class="it_showhide" for="displayProduct-star"><input name="'.$field['id'].'[email]" type="checkbox" '.(is_array($meta) && in_array("email",$meta) ? "CHECKED": "").' value="email" class="displayProduct-eneble">'.esc_html__('Email (To) Field',__IT_REPORT_WCREPORT_TEXTDOMAIN__).' </label>

							<label class="it_showhide" for="displayProduct-metatag"><input name="'.$field['id'].'[description]" type="checkbox" '.(is_array($meta) && in_array("description",$meta) ? "CHECKED": "").' value="description">'.esc_html__('Description Field',__IT_REPORT_WCREPORT_TEXTDOMAIN__).' </label>
							';
				}
				break;
...
$html.= ' <div class="awr-setting-submit">
				<button type="submit" value="Save Settings" class="button-primary"><i class="fa fa-floppy-o"></i> <span>'. esc_html__("Save settings",__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</span></button>
			</div>
		</form>
		</div>
		</div><!--awr-box -->
