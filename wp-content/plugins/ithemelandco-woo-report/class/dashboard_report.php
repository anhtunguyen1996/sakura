		...
		if ($this->dashboard($this->it_plugin_status)){
                        ...
                        <nav>
                            <ul class="tab-uls">
								...
								if($this->get_dashboard_capability('sale_by_months_chart')){
                                    ...
                                    <li><a href="#section-bar-1" class="" data-target="pwr_chartdiv_month"> <span><?php echo esc_html__('Sales By Months',__IT_REPORT_WCREPORT_TEXTDOMAIN__) ?></span></a></li>
								...
								if($this->get_dashboard_capability('sale_by_days_chart')){
									?>
                                    <li><a href="#section-bar-2" class="" data-target="pwr_chartdiv_day"> <span><?php echo esc_html__('Sales By Days',__IT_REPORT_WCREPORT_TEXTDOMAIN__) ?></span></a></li>

									<?php
								}
								if($this->get_dashboard_capability('3d_month_chart_chart')){
									?>
                                    <li><a href="#section-bar-3" class="" data-target="pwr_chartdiv_multiple"> <span><?php echo esc_html__('3D Month Chart',__IT_REPORT_WCREPORT_TEXTDOMAIN__) ?></span></a></li>

									<?php
								}
								if($this->get_dashboard_capability('top_products_chart')){
									?>
                                    <li><a href="#section-bar-4" class="" data-target="pwr_chartdiv_pie"> <span><?php echo esc_html__('Top Products',__IT_REPORT_WCREPORT_TEXTDOMAIN__) ?></span></a></li>
									<?php
								}
								?>
                            </ul>
                        ...
                        <div class="awr-theme-chart">
                            <ul>
                                <li  class="awr-theme-chart-title">
                                    <span class=""><?php echo  esc_html__('Click to change theme',__IT_REPORT_WCREPORT_TEXTDOMAIN__); ?>:&nbsp;&nbsp;</span>
                                </li>

                                <li class="it_switch_chart_theme it_switch_chart_theme_light" data-theme="light">
                                    <img width="36" height="35" src="<?php echo __IT_REPORT_WCREPORT_URL__?>/assets/images/theme_light2.png" alt="theme_light">
                                </li>

                                <li class="it_switch_chart_theme it_switch_chart_theme_dark" data-theme="dark">
                                    <img width="36" height="35" src="<?php echo __IT_REPORT_WCREPORT_URL__?>/assets/images/theme_dark2.png" alt="theme_dark">
                                </li>

                                <li class="it_switch_chart_theme " data-theme="patterns">
                                    <img width="36" height="35" src="<?php echo __IT_REPORT_WCREPORT_URL__?>/assets/images/theme_pattern2.png" alt="theme_patterns">
                                </li>

                                <li class="it_switch_chart_theme " data-theme="none">
                                    <img width="36" height="35" src="<?php echo __IT_REPORT_WCREPORT_URL__?>/assets/images/theme_none.png" alt="theme_none">
                                </li>
			...
			if($this->get_dashboard_capability('map') && $disbale_map=='off'){
                ...
                <div class="col-xs-12 col-md-12">
                    <div class="awr-box">
                        <div class="awr-title">
                            <h3><i class="fa fa-desktop"></i><?php _e('Map',__IT_REPORT_WCREPORT_TEXTDOMAIN__);?></h3>
                        ...
                        <div class="awr-box-content container5 pw-map-content">
                            ...
                            <div class="rightPanel">
                                <h2><?php echo  esc_html__('Select a year',__IT_REPORT_WCREPORT_TEXTDOMAIN__); ?></h2>
                                <div class="knobContainer">
                                    <input class="knob" data-width="80" data-height="80" data-min="<?php echo $first_date;?>" data-max="<?php echo $it_to_date; ?>" data-cursor=true data-fgColor="#454545" data-thickness=.45 value="<?php echo $first_date;?>" data-bgColor="#c7e8ff" />
                                </div>
            ...
            setTimeout(function(){
                ...
                $world.mapael({
                    ...
                    legend : {
                        ...
                        area : {
                            display : true,
                            title :"<?php _e('Country Orders Amount',__IT_REPORT_WCREPORT_TEXTDOMAIN__);?>",
                            marginBottom : 7,
                            slices : [
                                {
                                    ...
                                    label :'<?php _e('Less than',__IT_REPORT_WCREPORT_TEXTDOMAIN__);?> <?php echo  ($first_limit_country).' '.get_woocommerce_currency(); ?>'
                                },
                                {
                                    ...
                                    label :'> <?php echo ($first_limit_country).' '.get_woocommerce_currency(); ?> <?php _e('and',__IT_REPORT_WCREPORT_TEXTDOMAIN__);?> < <?php echo ($two_limit_country).' '.get_woocommerce_currency(); ?>'
                                },
                                {
                                    ...
                                    label :'<?php _e('More than',__IT_REPORT_WCREPORT_TEXTDOMAIN__);?> <?php echo ($two_limit_country).' '.get_woocommerce_currency(); ?>'
                                }
                            ]
                        },
						<?php
                        ...
                        plot :{
                            display : true,
                            title: "<?php _e('State Orders Amount',__IT_REPORT_WCREPORT_TEXTDOMAIN__);?>",
                            marginBottom : 6,
                            slices : [
                                {
                                    type :"circle",
                                    ...
                                    label :"<?php _e('Less than',__IT_REPORT_WCREPORT_TEXTDOMAIN__);?> <?php echo $first_limit_state.' '.get_woocommerce_currency();?>",
                                    size : 10
                                },
                                {
                                    type :"circle",
                                    ...
                                    label :"> <?php echo $first_limit_state.' '.get_woocommerce_currency().' '; ?> <?php _e('and',__IT_REPORT_WCREPORT_TEXTDOMAIN__);?> < <?php echo $two_limit_state.' '.get_woocommerce_currency(); ?>",
                                    size : 20
                                },
                                {
                                    type :"circle",
                                    ...
                                    label :"<?php _e('More than',__IT_REPORT_WCREPORT_TEXTDOMAIN__);?> <?php echo ' '.$two_limit_state.' '.get_woocommerce_currency(); ?>",
                                    size : 30
                                }
                            ]
                        }
...
<script>
    jQuery( document ).ready(function( $ ) {
        ...
        $(".awr-news-read-oldest").on("click",function(){
            if(toggle){
                $(".awr-news-read-oldest").html("<?php echo esc_html__('Hide Oldest News !',__IT_REPORT_WCREPORT_TEXTDOMAIN__)?>");
            }else
            {
                $(".awr-news-read-oldest").html("<?php echo esc_html__('Show Oldest News !',__IT_REPORT_WCREPORT_TEXTDOMAIN__)?>");
            }
