<div class="container my_content awr-maincontainer">
    ...
    <div class="pw-topbar-wrapper pw-full-menu" style="visibility: hidden">
        ...
        <div class="pw-rightbar-wrapper">
			...
			<div class="pw-righbar-icon pw-dark-icon" title="<?php _e("Change Theme",__IT_REPORT_WCREPORT_TEXTDOMAIN__);?>">
                <i class="fa fa-moon-o"></i>
            </div>

            <div class="pw-righbar-icon pw-switch-wordpress">
                <a class="pw-switch-wordpress-a" href="<?php echo get_admin_url();?>" title="<?php _e("Switch to wordpress dashboard",__IT_REPORT_WCREPORT_TEXTDOMAIN__);?>">
                    <i class="fa fa-wordpress"></i>
                </a>
            </div>

            <div class="pw-righbar-icon pw-expand-icon" title="<?php _e("Expand Window",__IT_REPORT_WCREPORT_TEXTDOMAIN__);?>">
	...
	update_option("it_report_menus",json_encode($our_menu));
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-6 col-md-3">
                <div class="awr-allmenu-box">
                    <div class="awr-menu-title"><i class="fa fa-check"></i><?php echo esc_html__('Basics',__IT_REPORT_WCREPORT_TEXTDOMAIN__); ?></a></div>
					<?php echo $basic_menu; ?>
                </div>
            </div>
			...
			if($tax_field_reports!='')
			{
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="awr-allmenu-box">
                        <div class="awr-menu-title"><i class="fa fa-random"></i><?php echo esc_html__('All Order with Taxonomies & Fields',__IT_REPORT_WCREPORT_TEXTDOMAIN__); ?></a></div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-3">
                <div class="awr-allmenu-box">
                    <div class="awr-menu-title"><i class="fa fa-files-o"></i><?php echo esc_html__('More Reports',__IT_REPORT_WCREPORT_TEXTDOMAIN__); ?></a></div>
			...
			if($cross_menu!='')
			{
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="awr-allmenu-box">
                        <div class="awr-menu-title"><i class="fa fa-random"></i><?php echo esc_html__('CrossTab',__IT_REPORT_WCREPORT_TEXTDOMAIN__); ?></a></div>
						<?php echo $cross_menu; ?>
                    </div>
                </div>
				<?php
            ...
            <div class="col-xs-12 col-sm-6 col-md-3">
                <div class="awr-allmenu-box">
                    <div class="awr-menu-title"><i class="fa fa-check"></i><?php echo esc_html__('Other',__IT_REPORT_WCREPORT_TEXTDOMAIN__); ?></a></div>
					<?php echo $other_menu; ?>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12 awr-allmenu-footer">
                <h3><?php echo esc_html__('WOOCommerce Advance Reporting System',__IT_REPORT_WCREPORT_TEXTDOMAIN__); ?></h3>
	...
	if ($this->dashboard($this->it_plugin_status)){
		...
		$this->our_menu = array(
			...
			"active_plugin" => array(
				"label" => esc_html__('Activate Plugin',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
				"id" => "active_plugin",
	...
	update_option("it_report_menus",json_encode($this->our_menu));
    ...
    <nav id="ml-menu" class="awr-menu"  style="visibility:hidden">
        <div class="awr-item" data-id="logo">
                <img src="<?php echo __IT_REPORT_WCREPORT_URL__ . "/assets/images/logo.png"; ?>" class="small image">
        </div>
    ...
    <div class="awr-content" style="visibility:hidden">
        ...
        <div class="pw-breadcrumb-wrapper">
			...
			if(isset($_GET['action']) || isset($_GET['id']))
				$page_title=str_replace("Add",esc_html__('Edit', __IT_WOO_BUNDLE_TEXTDOMAIN__),$page_title);

			?>
			<div class="pw-bread-title"><?php echo $page_title; ?></div>
            <div class="pw-breadcrumb-cnt">
                <a class="pw-section" href="<?php echo get_admin_url();?>admin.php?page=wcx_wcreport_plugin_dashboard&parent=dashboard">Home</a>
				<?php echo $breadcrumb; ?>
									...
									<div class="row">
										<div class="col-xs-12">
											<div class="awr-box awr-acc-box">
												...
												<h3 class="awr-acc-title">'. esc_html__("Access Denied !",__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</h3>
												<div class="awr-acc-desc">'. esc_html__("You have no permisson !! Please Contact site Administrator",__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</div>
											</div>
										</div><!--col-xs-12 -->
									</div><!--row -->
								</div><!--wrap -->';
