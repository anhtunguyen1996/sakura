                ...
                <div class="itwr-wrap">
                    <div class="itwr-tab-middle-content">
                        <div id="itwr-activation-info">
                            <strong><?php esc_html_e("Congratulations, Your plugin is activated successfully. Let's Go!", ITWR_NAME) ?></strong>
                        </div>
                    </div>
                </div>
            <?php else : ?>
                    ...
                    <div class="itwr-tab-middle-content">
                        ...
                        <form action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="post" id="itwr-activation-form">
                            ...
                            <div class="itwr-activation-field">
                                <label for="itwr-activation-email"><?php esc_html_e('Email', ITWR_NAME); ?> </label>
                                <input type="email" name="email" placeholder="Email ..." id="itwr-activation-email">
                            </div>
                            <div class="itwr-activation-field">
                                <label for="itwr-activation-industry"><?php esc_html_e('What is your industry?', ITWR_NAME); ?> </label>
                                <select name="industry" id="itwr-activation-industry">
                                    <option value=""><?php esc_html_e('Select', ITWR_NAME); ?></option>
                                    <?php
                                    if (!empty($industries)) :
                            ...
                            <button type="button" id="itwr-activation-activate" class="itwr-button itwr-button-lg itwr-button-blue" value="1"><?php esc_html_e('Activate', ITWR_NAME); ?></button>
                            <button type="button" id="itwr-activation-skip" class="itwr-button itwr-button-lg itwr-button-gray" style="float: left;" value="skip"><?php esc_html_e('Skip', ITWR_NAME); ?></button>
                        </form>
                    </div>
                </div>
            <?php endif; ?>
