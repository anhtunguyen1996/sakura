    ...
    class it_report_wcreport_class extends it_rpt_datatable_generate
    {
            ...
            if (defined("__IT_BRANDS_ADD_ON__")) {
                ...
                if ($enable_brands == 'yes_another') {
                    ...
                    $brand_label = get_option(
                        ...
                        esc_html__('Brand', __IT_REPORT_WCREPORT_TEXTDOMAIN__)
                    );
                    ...
                    if (!empty($_POST['email']) && !empty($_POST['industry'])) {
                        ...
                        if (!empty($info) && is_array($info)) {
                            if (!empty($info['result']) && $info['result'] == true) {
                                ...
                                $message = esc_html__('Success !', ITWR_NAME);
                            } else {
                                update_option('itwrl_is_active', 'no');
                                $message = (!empty($info['message'])) ? esc_html($info['message']) : esc_html__('System Error !', ITWR_NAME);
                            }
                        } else {
                            update_option('itwrl_is_active', 'no');
                            $message = esc_html__('Connection Timeout! Please Try Again', ITWR_NAME);
                        }
                    }
                }
            }
        ...
        public function menu_fields($index = '')
        {
            $menu_fields = array(
                'all_orders' => array(
                    'fields' => array(
                        "it_category_id" => esc_html__('Category', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                        "it_brand_id" => __IT_BRAND_SLUG__ ? __IT_BRAND_LABEL__ : false,
                        "it_product_id" => esc_html__('Product', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                        "it_countries_code" => esc_html__('Country', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                        "it_states_code" => esc_html__('State', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                        "it_orders_status" => esc_html__('Status', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                    ),
                    'cols' => array(),
                ),
                ...
                'product' => array(
                    'fields' => array(
                        "it_category_id" => esc_html__('Category', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                        "it_tags_id" => esc_html__('Tags', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                        "it_brand_id" => __IT_BRAND_SLUG__ ? __IT_BRAND_LABEL__ : false,
                        "it_product_id" => esc_html__('Product', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                        "it_orders_status" => esc_html__('Status', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                    ),
                ...
                'category' => array(
                    'fields' => array(
                        "it_parent_category_id" => esc_html__('Category', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                    ),
                    'cols' => array(),
                ),
                ...
                'order_variation_analysis' => array(
                    'fields' => array(
                        "it_products" => esc_html__('Product', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                    ),
                    'cols' => array(),
                ),
            ...
            if (defined("__IT_CROSSTABB_ADD_ON__")) {
                ...
                $new_menu = array(
                    'fields' => array(
                        "it_categories" => esc_html__('Category', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                        "it_brand_id" => __IT_BRAND_SLUG__ ? __IT_BRAND_LABEL__ : false,
                        "it_orders_status" => esc_html__('Status', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                        "it_products" => esc_html__('Product', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                    ),
            ...
            if (defined("__IT_TAX_FIELD_ADD_ON__")) {
                ...
                $new_menu = array(
                    'fields' => array(
                        "it_parent_brand_id" => esc_html__('Brand', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                    ),
                    'cols' => array(),
                );
                ...
                $new_menu = array(
                    'fields' => array(
                        "it_customy_taxonomies" => esc_html__('Product Taxonimies', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                    ),
                    'cols' => array(),
                );
                ...
                $param_line = '
					<div class="col-md-6" style="border:#f2c811 2px solid;width:100%">
						<div class="awr-form-title" style="padding: 7px 5px 10px;text-align: center;background: #f2c811;color: #fff;">
							' . esc_html__('Custom Taxonomy', __IT_REPORT_WCREPORT_TEXTDOMAIN__) . '
						</div>' . $param_line . '</div>';
            }
        ...
        public function it_po_fields_fetch_field($order_item_id, $field = '')
        {
            ...
            $types = $wpdb->get_results(
                "SELECT it_itemmeta.meta_value as meta_value FROM {$wpdb->prefix}woocommerce_order_itemmeta as it_itemmeta where it_itemmeta.meta_key='_tmcartepo_data' and it_itemmeta.order_item_id='" . $order_item_id . "'",
                ARRAY_A
            );
            if (defined('THEMECOMPLETE_EPO_VERSION') && version_compare(THEMECOMPLETE_EPO_VERSION, "4.6", ">=") && $types == null) {
                ...
                $types = $wpdb->get_results(
                    "SELECT it_itemmeta.meta_value as meta_value FROM {$wpdb->prefix}woocommerce_order_itemmeta as it_itemmeta where it_itemmeta.meta_key LIKE '%$field%' and it_itemmeta.order_item_id='" . $order_item_id . "'",
                    ARRAY_A
                );
...
where pitems.order_id='$order_id' AND pmeta.meta_key='_wc_eco_fields_value' AND pmeta_p.meta_key='_wc_eco_element_id' AND pmeta_p.meta_value='$field'";
        ...
        public function it_report_setup_menus()
        {
            ...
            add_menu_page(
                '<span style="color: #627ddd;font-weight: 900;">iT </span>' . esc_html__('Woo Report', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                '<span style="color: #627ddd;font-weight: 900;">iT </span>' . esc_html__('Woo Report', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                $role_capability,
                $this->it_plugin_main_url,
                array($this, 'wcx_plugin_dashboard'),
                //'dashicons-chart-pie',
                __IT_REPORT_WCREPORT_URL__ . '/assets/images/mini_logo_20.png',
                65
            );

            add_submenu_page(
                $this->it_plugin_main_url,
                esc_html__('Settings', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                esc_html__('Settings', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                $role_capability,
            ...
            add_submenu_page(
                $this->it_plugin_main_url,
                esc_html__('Activation', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                esc_html__('Activation', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                $role_capability,
            ...
            add_submenu_page(
                null,
                esc_html__('Dashboard', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                esc_html__('Dashboard', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                $role_capability,
            ...
            add_submenu_page(
                null,
                esc_html__('My Dashboard', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                esc_html__('My Dashboard', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                $role_capability,
            ...
            add_submenu_page(
                null,
                esc_html__('Details', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                esc_html__('Details', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                $role_capability,
            ...
            //CUSTOM WORK - 12300
            //add_submenu_page(null, esc_html__('Details Tickera',__IT_REPORT_WCREPORT_TEXTDOMAIN__), esc_html__('Details Tickera',__IT_REPORT_WCREPORT_TEXTDOMAIN__), $role_capability, 'wcx_wcreport_plugin_details_tickera',   array($this,'wcx_plugin_menu_details_tickera' ) );

            //CUSTOM WORK - 4186
            add_submenu_page(
                null,
                esc_html__('Details Full', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                esc_html__('Details Full', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                $role_capability,
            ...
            add_submenu_page(
                null,
                esc_html__('Details Full Billing/Shipping', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                esc_html__('Details Full Billing/Shipping', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                $role_capability,
            ...
            add_submenu_page(
                null,
                esc_html__('Combined Orders', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                esc_html__('Combined Orders', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                $role_capability,
            ...
            add_submenu_page(
                null,
                esc_html__('Status Change', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                esc_html__('Status Change', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                $role_capability,
            ...
            add_submenu_page(
                null,
                esc_html__('All Orders (Custom Taxonomy, Field)', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                esc_html__('All Orders (Custom Taxonomy, Field)', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                $role_capability,
            ...
            add_submenu_page(
                null,
                esc_html__('Order/Country', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                esc_html__('Order Per Country', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                $role_capability,
            ...
            add_submenu_page(
                null,
                esc_html__('Product', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                esc_html__('Product', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                $role_capability,
            ...
            add_submenu_page(
                null,
                esc_html__('All Products', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                esc_html__('All Products', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                $role_capability,
            ...
            add_submenu_page(
                null,
                esc_html__('Stock List', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                esc_html__('Stock List', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                $role_capability,
            ...
            add_submenu_page(
                null,
                esc_html__('Product/Users', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                esc_html__('Product/Users', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                $role_capability,
            ...
            add_submenu_page(
                null,
                esc_html__('Profit', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                esc_html__('Profit', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                $role_capability,
            ...
            add_submenu_page(
                null,
                esc_html__('Category', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                esc_html__('Category', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                $role_capability,
            ...
            add_submenu_page(
                null,
                esc_html__('Tag', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                esc_html__('Tag', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                $role_capability,
            ...
            add_submenu_page(
                null,
                esc_html__('Customer', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                esc_html__('Customer', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                $role_capability,
            ...
            add_submenu_page(
                null,
                esc_html__('Billing Country', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                esc_html__('Billing Country', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                $role_capability,
            ...
            add_submenu_page(
                null,
                esc_html__('Billing State', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                esc_html__('Billing State', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                $role_capability,
            ...
            add_submenu_page(
                null,
                esc_html__('Billing City', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                esc_html__('Billing City', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                $role_capability,
            ...
            add_submenu_page(
                null,
                esc_html__('Payment Gateway', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                esc_html__('Payment Gateway', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                $role_capability,
            ...
            add_submenu_page(
                null,
                esc_html__('Order Status', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                esc_html__('Order Status', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                $role_capability,
            ...
            add_submenu_page(
                null,
                esc_html__('Recent Order', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                esc_html__('Recent Order', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                $role_capability,
            ...
            add_submenu_page(
                null,
                esc_html__('Tax Report', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                esc_html__('Tax Report', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                $role_capability,
            ...
            add_submenu_page(
                null,
                esc_html__('Purchased Product by Customer', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                esc_html__('Purchased Product by Customer', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                $role_capability,
            ...
            if (is_array(__CUSTOMWORK_ID__) && in_array('17427', __CUSTOMWORK_ID__)) {
                add_submenu_page(
                    null,
                    esc_html__('Purchased Category by Customer', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                    esc_html__('Purchased Category by Customer', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                    $role_capability,
            ...
            if (is_array(__CUSTOMWORK_ID__) && in_array('15092', __CUSTOMWORK_ID__)) {
                add_submenu_page(
                    null,
                    esc_html__('Order Per Shipping', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                    esc_html__('Order Per Shipping', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                    $role_capability,
            ...
            add_submenu_page(
                null,
                esc_html__('Refund Orders', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                esc_html__('Refund Orders', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                $role_capability,
            ...
            add_submenu_page(
                null,
                esc_html__('Coupon', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                esc_html__('Coupon', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                $role_capability,
            ...
            if (is_array(__CUSTOMWORK_ID__) && in_array('12679', __CUSTOMWORK_ID__)) {
                add_submenu_page(
                    null,
                    esc_html__('Total Sales per Clinic', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                    esc_html__('Total Sales per Clinic', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                    $role_capability,
            ...
            add_submenu_page(
                null,
                esc_html__('Coupon Discount', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                esc_html__('Coupon Discount', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                $role_capability,
            ...
            add_submenu_page(
                null,
                esc_html__('Customer Analysis', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                esc_html__('Customer Analysis', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                $role_capability,
                'wcx_wcreport_plugin_customer_analysis',
                array($this, 'wcx_plugin_menu_customer_analysis')
            );
            //add_submenu_page(null, esc_html__('Frequently Order Customer',__IT_REPORT_WCREPORT_TEXTDOMAIN__), esc_html__('Frequently Order Customer',__IT_REPORT_WCREPORT_TEXTDOMAIN__), $role_capability, 'wcx_wcreport_plugin_customer_order_frequently',   array($this,'wcx_plugin_menu_customer_order_frequently' ) );
            add_submenu_page(
                null,
                esc_html__('Customer in Price Point', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                esc_html__('Customer in Price Point', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                $role_capability,
            ...
            add_submenu_page(
                null,
                esc_html__('Customer/Non Purchase', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                esc_html__('Customer/Non Purchase', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                $role_capability,
            ...
            add_submenu_page(
                null,
                esc_html__('Zero Level Stock', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                esc_html__('Zero Level Stock', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                $role_capability,
            ...
            add_submenu_page(
                null,
                esc_html__('Minimum Level Stock', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                esc_html__('Minimum Level Stock', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                $role_capability,
            ...
            add_submenu_page(
                null,
                esc_html__('Most Stocked', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                esc_html__('Most Stocked', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                $role_capability,
            ...
            add_submenu_page(
                null,
                esc_html__('Summary Stock Planner', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                esc_html__('Summary Stock Planner', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                $role_capability,
            ...
            add_submenu_page(
                null,
                esc_html__('Analysis Simple products', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                esc_html__('Analysis Simple products', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                $role_capability,
            ...
            add_submenu_page(
                null,
                esc_html__('Analysis Variation products', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                esc_html__('Analysis Simple products', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                $role_capability,
            ...
            add_submenu_page(
                null,
                esc_html__('Project VS Actual Sale', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                esc_html__('Project VS Actual Sale', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                $role_capability,
            ...
            add_submenu_page(
                null,
                esc_html__('Tax Reports', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                esc_html__('Tax Reports', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                $role_capability,
            ...
            add_submenu_page(
                null,
                esc_html__('Product Qty.', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                esc_html__('Product Qty.', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                $role_capability,
            ...
            add_submenu_page(
                null,
                esc_html__('Abandoned Products', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                esc_html__('Products', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                $role_capability,
            ...
            add_submenu_page(
                null,
                esc_html__('Abandoned Carts', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                esc_html__('Abandoned Carts Data', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                $role_capability,
            ...
            add_submenu_page(
                null,
                esc_html__('Settings', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                esc_html__('Report Settings', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                $role_capability,
            ...
            add_submenu_page(
                null,
                esc_html__('Add-ons', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                esc_html__('Report Add-ons', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                $role_capability,
            ...
            add_submenu_page(
                null,
                esc_html__('Activate Plugin', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                esc_html__('Active Plugin', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                $role_capability,
        ...
        public function pages_fetch($page, $display = "all")
        {
            ...
            $this->our_menu = array(
                "logo" => array(
                    ...
                    "id" => "logo",
                    "link" => '#',
                    "icon" => __IT_REPORT_WCREPORT_URL__ . "/assets/images/logo.png",
                    "mini_icon" => __IT_REPORT_WCREPORT_URL__ . "/assets/images/mini_logo.png",
                ),

                "dashboard" => array(
                    "label" => esc_html__('Dashboard', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                    "id" => "dashboard",
                ...
                "all_order_reports" => array(
                    "label" => esc_html__('Order', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                    "id" => "all_order_reports",
                    "link" => "#",
                    "icon" => "fa-shopping-cart",
                    "childs" => array(
                        "all_orders" => array(
                            "label" => esc_html__('All Orders', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                            "id" => "all_orders",
                        ...
                        //                            "label" => esc_html__('All Orders Tickera', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                        ...
                        "all_orders_full" => array(
                            "label" => '<span style="color:#d97c7c">' . esc_html__("All Orders Billing(Pro)", __IT_REPORT_WCREPORT_TEXTDOMAIN__) . '</span>',
                            "id" => "all_orders_full",
                            "link" => "#",
                            "icon" => "fa-file-text",
                        ),
                        "order_per_country" => array(
                            "label" => '<span style="color:#d97c7c">' . esc_html__("Order/Country(Pro)", __IT_REPORT_WCREPORT_TEXTDOMAIN__) . '</span>',
                            "id" => "order_per_country",
                            "link" => "#",
                            "icon" => "fa-eye-slash",
                        ),
                        "order_status" => array(
                            "label" => '<span style="color:#d97c7c">' . esc_html__("Order Status(Pro)", __IT_REPORT_WCREPORT_TEXTDOMAIN__) . '</span>',
                            "id" => "order_status",
                            "link" => "#",
                            "icon" => "fa-check",
                        ),
                        ...
                        "order_status_change" => array(
                            "label" => esc_html__("Status Change", __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                            "id" => "order_status_change",
                            "link" => "#",
                            "icon" => "fa-check",
                        ),
                        "recent_order" => array(
                            "label" => '<span style="color:#d97c7c">' . esc_html__("Recent Order(Pro)", __IT_REPORT_WCREPORT_TEXTDOMAIN__) . '</span>',
                            "id" => "recent_order",
                            "link" => "#",
                            "icon" => "fa-shopping-cart",
                        ),
                        "refund_detail" => array(
                            "label" => esc_html__("Refund Orders", __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                            "id" => "refund_detail",
                        ...
                        //ORDER ANALYSIS
                        "order_product_analysis" => array(
                            "label" => '<span style="color:#d97c7c">' . esc_html__("Analysis Simple Products(Pro)", __IT_REPORT_WCREPORT_TEXTDOMAIN__) . '</span>',
                            "id" => "order_product_analysis",
                            "link" => "#",
                            "icon" => "fa-line-chart",
                        ),
                        "order_variation_analysis" => array(
                            "label" => '<span style="color:#d97c7c">' . esc_html__("Analysis Variation Products(Pro)", __IT_REPORT_WCREPORT_TEXTDOMAIN__) . '</span>',
                ...
                //                    "label" => esc_html__('Abandoned Cart',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
                //                    "id" => "abandoned_carts",
                //                    "link" => "#",
                //                    "icon" => "fa-shopping-cart",
                //                    "childs" => array(
                //                        "abandoned_products" => array(
                //                            "label" => esc_html__("Products" ,__IT_REPORT_WCREPORT_TEXTDOMAIN__),
                ...
                //                            "label" => esc_html__('Cart Data',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
                //                            "id" => "abandoned_cart",
                ...
                "product_reports" => array(
                    "label" => esc_html__('Product', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                    "id" => "product_reports",
                    "link" => "#",
                    ...
                    "childs" => array(
                        ...
                        "product" => array(
                            "label" => esc_html__("Purchased Product", __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                            "id" => "product",
                        ...
                        "product_variation_qty" => array(
                            "label" => '<span style="color:#d97c7c">' . esc_html__("Purchased Product Qty(Pro)", __IT_REPORT_WCREPORT_TEXTDOMAIN__) . '</span>',
                        ...
                        "product_per_users" => array(
                            "label" => '<span style="color:#d97c7c">' . esc_html__("Product/Users(Pro)", __IT_REPORT_WCREPORT_TEXTDOMAIN__) . '</span>',
                        ...
                        "category" => array(
                            "label" => esc_html__("Category", __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                            "id" => "category",
                        ...
                        ////ADDED IN VER4.0
                        "tags" => array(
                            "label" => '<span style="color:#d97c7c">' . esc_html__("Tag(Pro)", __IT_REPORT_WCREPORT_TEXTDOMAIN__) . '</span>',
                            "id" => "tags",
                            "link" => "#",
                            "icon" => "fa-tags",
                        ),
                        ...
                        "customer_buy_prod" => array(
                            "label" => '<span style="color:#d97c7c">' . esc_html__("Purchased Product by Customer(Pro)", __IT_REPORT_WCREPORT_TEXTDOMAIN__) . '</span>',
                        ...
                        "stock_list" => array(
                            "label" => esc_html__('Product Stock', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                            "id" => "stock_list",
                        ...
                        "stock_zero_level" => array(
                            "label" => '<span style="color:#d97c7c">' . esc_html__("Zero Level Stock(Pro)", __IT_REPORT_WCREPORT_TEXTDOMAIN__) . '</span>',
                            "id" => "stock_zero_level",
                            "link" => "#",
                            "icon" => "fa-exclamation-triangle",
                        ),
                        "stock_min_level" => array(
                            "label" => '<span style="color:#d97c7c">' . esc_html__("Minimum Level Stock(Pro)", __IT_REPORT_WCREPORT_TEXTDOMAIN__) . '</span>',
                            "id" => "stock_min_level",
                            "link" => "#",
                            "icon" => "fa-level-down",
                        ),
                        "stock_max_level" => array(
                            "label" => '<span style="color:#d97c7c">' . esc_html__("Most Stocked(Pro)", __IT_REPORT_WCREPORT_TEXTDOMAIN__) . '</span>',
                            "id" => "stock_max_level",
                            "link" => "#",
                            "icon" => "fa-level-up",
                        ),
                        "stock_summary_avg" => array(
                            "label" => '<span style="color:#d97c7c">' . esc_html__("Summary Stock Planner(Pro)", __IT_REPORT_WCREPORT_TEXTDOMAIN__) . '</span>',
                ...
                "customer_reports" => array(
                    "label" => esc_html__('Customer', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                    "id" => "customer_reports",
                    "link" => "#",
                    "icon" => "fa-user",
                    "childs" => array(
                        ...
                        "customer_analysis" => array(
                            "label" => '<span style="color:#d97c7c">' . esc_html__("Customer Analysis(Pro)", __IT_REPORT_WCREPORT_TEXTDOMAIN__) . '</span>',
                            "id" => "customer_analysis",
                            "link" => "#",
                            "icon" => "fa-bar-chart",
                        ),
                        "customer_min_max" => array(
                            "label" => '<span style="color:#d97c7c">' . esc_html__("Customer Min-Max(Pro)", __IT_REPORT_WCREPORT_TEXTDOMAIN__) . '</span>',
                            "id" => "customer_min_max",
                            "link" => "#",
                            "icon" => "fa-hand-pointer-o",
                        ),
                        "customer_no_purchased" => array(
                            "label" => esc_html__("Customer/Non Purchase", __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                ...
                "more_reports" => array(
                    "label" => esc_html__('More Reports', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                    "id" => "more_reports",
                    "link" => "#",
                    "icon" => "fa-files-o",
                    "childs" => array(
                        ...
                        "profit" => __IT_COG__ != '' ? array(
                            "label" => esc_html__("Profit", __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                            "id" => "profit",
                        ...
                        "billing_country" => array(
                            "label" => esc_html__("Billing Country", __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                            "id" => "billing_country",
                            "link" => "admin.php?page=wcx_wcreport_plugin_billingcountry&parent=more_reports&smenu=billing_country",
                            "icon" => "fa-globe",
                        ),
                        "billing_state" => array(
                            "label" => '<span style="color:#d97c7c">' . esc_html__("Billing State(Pro)", __IT_REPORT_WCREPORT_TEXTDOMAIN__) . '</span>',
                            "id" => "billing_state",
                            "link" => "#",
                            "icon" => "fa-map",
                        ),
                        ////ADDED IN VER4.0
                        "billing_city" => array(
                            "label" => '<span style="color:#d97c7c">' . esc_html__("Billing City(Pro)", __IT_REPORT_WCREPORT_TEXTDOMAIN__) . '</span>',
                            "id" => "billing_city",
                            "link" => "#",
                            "icon" => "fa-map-marker",
                        ),
                        "payment_gateway" => array(
                            "label" => esc_html__("Payment Gateway", __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                            "id" => "payment_gateway",
                        ...
                        "coupon" => array(
                            "label" => '<span style="color:#d97c7c">' . esc_html__("Coupon(Pro)", __IT_REPORT_WCREPORT_TEXTDOMAIN__) . '</span>',
                            "id" => "coupon",
                            "link" => "#",
                            "icon" => "fa-hashtag",
                        ),
                        "coupon_discount" => array(
                            "label" => '<span style="color:#d97c7c">' . esc_html__("Coupon Discount(Pro)", __IT_REPORT_WCREPORT_TEXTDOMAIN__) . '</span>',
                            "id" => "coupon_discount",
                            "link" => "#",
                            "icon" => "fa-percent",
                        ),
                        "proj_actual_sale" => array(
                            "label" => '<span style="color:#d97c7c">' . esc_html__("Project VS Actual Sale(Pro)", __IT_REPORT_WCREPORT_TEXTDOMAIN__) . '</span>',
                            "id" => "proj_actual_sale",
                            "link" => "#",
                ...
                "tax_reports" => array(
                    "label" => esc_html__('Tax', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                    "id" => "tax_reports",
                    "link" => "#",
                    "icon" => "fa-percent",
                    "childs" => array(
                        "tax_report" => array(
                            "label" => esc_html__("Tax Report", __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                            "id" => "tax_report",
                            "link" => "admin.php?page=wcx_wcreport_plugin_taxreport&parent=tax_reports&smenu=tax_report",
                            "icon" => "fa-pie-chart",
                        ),
                        "tax_reports" => array(
                            "label" => '<span style="color:#d97c7c">' . esc_html__("Tax Reports(Pro)", __IT_REPORT_WCREPORT_TEXTDOMAIN__) . '</span>',
                            "id" => "tax_reports",
                            "link" => "#",
                            "icon" => "fa-pie-chart",
                        ),
                ...
                "setting" => array(
                    "label" => esc_html__('Settings', __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                    "id" => "setting",
            ...
            if (is_array(__CUSTOMWORK_ID__) && in_array('53', __CUSTOMWORK_ID__)) {
                ...
                $extra_menu = array(
                    "label" => '<span style="color:#d97c7c">' . esc_html__("All Orders Billing/Shipping(Pro)", __IT_REPORT_WCREPORT_TEXTDOMAIN__) . '</span>',
            ...
            if (is_array(__CUSTOMWORK_ID__) && in_array('16', __CUSTOMWORK_ID__)) {
                ...
                $extra_menu = array(
                    "label" => '<span style="color:#d97c7c">' . esc_html__("All Orders Billing|Shipping Tax(Pro)", __IT_REPORT_WCREPORT_TEXTDOMAIN__) . '</span>',
            ...
            if (is_array(__CUSTOMWORK_ID__) && in_array('522', __CUSTOMWORK_ID__)) {
                ...
                $extra_menu = array(
                    "label" => '<span style="color:#d97c7c">' . esc_html__("Combined Orders(Pro)", __IT_REPORT_WCREPORT_TEXTDOMAIN__) . '</span>',
                    "id" => "details_combined",
                    "link" => "#",
                    "icon" => "fa-area-chart",
                );
            ...
            if (is_array(__CUSTOMWORK_ID__) && in_array('12679', __CUSTOMWORK_ID__)) {
                ...
                $extra_menu = array(
                    "label" => esc_html__("Total Sales per Clinic", __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                    "id" => "clinic",
            ...
            if (is_array(__CUSTOMWORK_ID__) && in_array('15092', __CUSTOMWORK_ID__)) {
                ...
                $extra_menu = array(
                    "label" => '<span style="color:#d97c7c">' . esc_html__("Order / Shipping(Pro)", __IT_REPORT_WCREPORT_TEXTDOMAIN__) . '</span>',
            ...
            if (is_array(__CUSTOMWORK_ID__) && in_array('17427', __CUSTOMWORK_ID__)) {
                ...
                $extra_menu = array(
                    "label" => '<span style="color:#d97c7c">' . esc_html__("Purchased Category by Customer(Pro)", __IT_REPORT_WCREPORT_TEXTDOMAIN__) . '</span>',
            ...
            if (is_array(__CUSTOMWORK_ID__) && in_array('966', __CUSTOMWORK_ID__)) {
                ...
                $extra_menu = array(
                    "label" => esc_html__("All Products", __IT_REPORT_WCREPORT_TEXTDOMAIN__),
                    "id" => "all_products",
            ...
            if ($fav_menu_html != '') {
                ...
                $menu_html_mini_fav .= '
					<div class="awr-item ' . $fav_active . '"  data-id="fav">
                      ...
                      <div class="awr-sub-title">' . esc_html__('Favorite Menus', __IT_REPORT_WCREPORT_TEXTDOMAIN__) . '</div>
			            </span>';
                $fav_menu_html_mini_submenu .= '
        ...
        public function wcx_send_email_schedule()
        {
            ...
            if ($email_daily_report == 1) :
                ...
                $end_date = $today_date;
                $title = esc_html__("Today", __IT_REPORT_WCREPORT_TEXTDOMAIN__);
                $email_data .= "<br>";
            ...
            if ($email_yesterday_report == 1) :
                ...
                $title = esc_html__("Yesterday", __IT_REPORT_WCREPORT_TEXTDOMAIN__);
                $email_data .= "<br>";
                $email_data .= $this->it_fetch_general_email_data(
                    $start_date,
                    $end_date,
            ...
            if ($email_weekly_report == 1) :
                ...
                $title = esc_html__("Current Week", __IT_REPORT_WCREPORT_TEXTDOMAIN__);
                $email_data .= "<br>";
                $email_data .= $this->it_fetch_general_email_data(
                    $start_date,
                    $end_date,
            ...
            if ($email_last_week_report == 1) :
                ...
                $title = esc_html__("Last Week", __IT_REPORT_WCREPORT_TEXTDOMAIN__);
                $email_data .= "<br>";
                $email_data .= $this->it_fetch_general_email_data(
                    $start_date,
                    $end_date,
            ...
            if ($email_monthly_report == 1) :
                ...
                $title = esc_html__("Current Month", __IT_REPORT_WCREPORT_TEXTDOMAIN__);
                $email_data .= "<br>";
                $email_data .= $this->it_fetch_general_email_data(
                    $start_date,
                    $end_date,
            ...
            if ($email_last_month_report == 1) :
                ...
                $title = esc_html__("Last Month", __IT_REPORT_WCREPORT_TEXTDOMAIN__);
                $email_data .= "<br>";
                $email_data .= $this->it_fetch_general_email_data(
                    $start_date,
                    $end_date,
            ...
            if ($email_this_year_report == 1) :
                ...
                $title = esc_html__("Current Year", __IT_REPORT_WCREPORT_TEXTDOMAIN__);
                $email_data .= "<br>";
                $email_data .= $this->it_fetch_general_email_data(
                    $start_date,
                    $end_date,
            ...
            if ($email_last_year_report == 1) :
                ...
                $title = esc_html__("Last Year", __IT_REPORT_WCREPORT_TEXTDOMAIN__);
                $email_data .= "<br>";
                $email_data .= $this->it_fetch_general_email_data(
                    $start_date,
                    $end_date,
            ...
            if ($email_till_today_report == 1) :
                ...
                $title = esc_html__("Till Date", __IT_REPORT_WCREPORT_TEXTDOMAIN__);
                $email_data .= "<br>";
                $email_data .= $this->it_fetch_general_email_data(
                    $start_date,
                    $end_date,
            ...
            if ($email_product_by_customer == 1) :
                ...
                $end_date = date('Y-m-t', strtotime('last month', $timestamp));
                $start_date = date('Y-m-01', strtotime('last month', $timestamp));
                $title = esc_html__("Purchased Product by Customer - Last Month", __IT_REPORT_WCREPORT_TEXTDOMAIN__);
                $email_data .= "<br>";
        ...
        public function it_order_first_date($key = null)
        {
            ...
            if ($this->it_firstorderdate) {
                ...
                return $this->it_firstorderdate = $wpdb->get_var($sql);
            }
        }
        ...
        public function it_intelligence_product_images($title = 'No Title', $id = '', $url = false)
        {
            ...
            //$rand_img=rand(1,5);
            if ($url) {
                $img = __IT_REPORT_WCREPORT_URL__ . '/assets/images/products/' . $first_letter . '/' . $image_num . '.jpg';
            } else {
                $img = '<img src="' . __IT_REPORT_WCREPORT_URL__ . '/assets/images/products/' . $first_letter . '/' . $image_num . '.jpg">';
            }
