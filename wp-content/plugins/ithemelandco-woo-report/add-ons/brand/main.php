...
if(!class_exists('it_report_wcreport_brands_addon_class')){
	...
	class it_report_wcreport_brands_addon_class{
		...
		function add_page_titles($page_titles){
			$page_titles['details_brands']=__( "All Orders per Brands",__IT_REPORT_WCREPORT_TEXTDOMAIN__);
			$page_titles['brand']=__( "Brand Report",__IT_REPORT_WCREPORT_TEXTDOMAIN__);
			$page_titles['custom_taxonomy']=__( "Custom Taxonomy",__IT_REPORT_WCREPORT_TEXTDOMAIN__);
		...
		function add_brands() {
			...
			//CUSTOM TAX & FIELDS
			add_submenu_page(null, __('All Orders (Custom Taxonomy, Field)',__IT_REPORT_WCREPORT_TEXTDOMAIN__), __('All Orders (Custom Taxonomy, Field)',__IT_REPORT_WCREPORT_TEXTDOMAIN__), $role_capability, 'wcx_wcreport_plugin_all_order_brands',   array($this,'wcx_plugin_menu_all_order_brands' ) );

			add_submenu_page(null, __('Brands Report',__IT_REPORT_WCREPORT_TEXTDOMAIN__), __('Brands Reoprt',__IT_REPORT_WCREPORT_TEXTDOMAIN__), $role_capability, 'wcx_wcreport_plugin_brand_brands',   array($this,'wcx_plugin_menu_brand_brands' ) );
		}
		...
		function add_fetch_page_brands( $visible_menu ) {
			$brands_menu=array(
						"label" => '<span style="color:#d97c7c">'.__("Brands Reports(Pro)",__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</span>',
						"id" => "brands_reports",
						"link" => "#",
						"icon" => "fa-tag",
						"childs" => array(
							"details_brands" => array(
								"label" => '<span style="color:#d97c7c">'.__("All Orders Per Brands(Pro)" ,__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</span>',
								"id" => "details_brands",
								"link" => "#",
								"icon" => "fa-cog",
							),
							"brand_brands" => array(
								"label" => '<span style="color:#d97c7c">'.__("Brands Report(Pro)" ,__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</span>',
								"id" => "brand_brands",
