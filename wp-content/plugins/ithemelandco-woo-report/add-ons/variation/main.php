...
if(!class_exists('it_report_wcreport_variation_addon_class')){
	...
	class it_report_wcreport_variation_addon_class{
		...
		function add_page_titles($page_titles){
			$page_titles['variation'] = __( "Purchased Variation",__IT_REPORT_WCREPORT_TEXTDOMAIN__);
			$page_titles['variation_stock']=__( "Variation Stock",__IT_REPORT_WCREPORT_TEXTDOMAIN__);
		...
		function add_variation_menu() {
			...
			add_submenu_page(null, __('Variation',__IT_REPORT_WCREPORT_TEXTDOMAIN__), __('Variation',__IT_REPORT_WCREPORT_TEXTDOMAIN__), $role_capability, 'wcx_wcreport_plugin_variation',  array($this, 'wcx_plugin_menu_variation' ) );
			
			add_submenu_page(null, __('Variation Stock',__IT_REPORT_WCREPORT_TEXTDOMAIN__), __('Variation Stock',__IT_REPORT_WCREPORT_TEXTDOMAIN__), $role_capability, 'wcx_wcreport_plugin_variation_stock', array($this, 'wcx_plugin_menu_variation_stock' ));
		...
		function add_fetch_page_variation_menu( $visible_menu ) {
			...
			$var_menu=array(
							"label" => '<span style="color:#d97c7c">'.__("Purchased Variation(Pro)",__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</span>',
							"id" => "variation",
							"link" => "#",
							"icon" => "fa-server",
						);
			...
			$var_stock_menu=array(
							"label" => '<span style="color:#d97c7c">'.__("Variation Stock(Pro)",__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</span>',
							"id" => "variation_stock",
							"link" => "#",
							"icon" => "fa-rocket",
						);			
