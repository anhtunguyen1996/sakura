...
if(!class_exists('it_report_wcreport_customer_role_addon_class')){
	...
	class it_report_wcreport_customer_role_addon_class{
		...
		function add_page_titles($page_titles){
			$page_titles['customer_role_total_sale']=__( "Total Sales",__IT_REPORT_WCREPORT_TEXTDOMAIN__);
			$page_titles['customer_role_registered']=__( "New User Sign-Up",__IT_REPORT_WCREPORT_TEXTDOMAIN__);
			$page_titles['customer_role_top_products']=__( "Top 20 Products",__IT_REPORT_WCREPORT_TEXTDOMAIN__);
			$page_titles['customer_role_bottom_products']=__( "Lowly 20 Products",__IT_REPORT_WCREPORT_TEXTDOMAIN__);
			return $page_titles;
		}
		...
		function add_customer_role() {
			...
			//CUSTOM TAX & FIELDS
			add_submenu_page(null, __('Total Sales',__IT_REPORT_WCREPORT_TEXTDOMAIN__), __('Total Sales',__IT_REPORT_WCREPORT_TEXTDOMAIN__), $role_capability, 'wcx_wcreport_plugin_customer_role_total_sale',   array($this,'wcx_plugin_menu_customer_role_total_sale' ) );

			add_submenu_page(null, __('New User Sign-Up',__IT_REPORT_WCREPORT_TEXTDOMAIN__), __('New User Sign-Up',__IT_REPORT_WCREPORT_TEXTDOMAIN__), $role_capability, 'wcx_wcreport_plugin_customer_role_registered',   array($this,'wcx_plugin_menu_customer_role_registered' ) );

			add_submenu_page(null, __('Top 20 Products',__IT_REPORT_WCREPORT_TEXTDOMAIN__), __('Top 20 Products',__IT_REPORT_WCREPORT_TEXTDOMAIN__), $role_capability, 'wcx_wcreport_plugin_customer_role_top_products',   array($this,'wcx_plugin_menu_customer_role_top_products' ) );

			add_submenu_page(null, __('Bottom 20 Products',__IT_REPORT_WCREPORT_TEXTDOMAIN__), __('Top 20 Products',__IT_REPORT_WCREPORT_TEXTDOMAIN__), $role_capability, 'wcx_wcreport_plugin_customer_role_bottom_products',   array($this,'wcx_plugin_menu_customer_role_bottom_products' ) );
		...
		function add_fetch_page_customer_role( $visible_menu ) {
			$group_role_menu=array(
				"label" => __('Customer Role/Group',__IT_REPORT_WCREPORT_TEXTDOMAIN__),
				"id" => "customer_role_group",
				"link" => "#",
				"icon" => "fa-user-circle",
				"childs" => array(
					"customer_role_total_sale" => array(
						"label" => __("Total Sales" ,__IT_REPORT_WCREPORT_TEXTDOMAIN__),
					...
					"customer_role_registered" => array(
						"label" => '<span style="color:#d97c7c">'.__("New User Sign-Up(Pro)" ,__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</span>',
						"id" => "customer_role_registered",
						"link" => "#",
						"icon" => "fa-user-plus",
					),
					"customer_role_top_products" => array(
						"label" => __("Top 20 Products" ,__IT_REPORT_WCREPORT_TEXTDOMAIN__),
					...
					"customer_role_bottom_products" => array(
						"label" => '<span style="color:#d97c7c">'.__("Lowly 20 Products(Pro)" ,__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</span>',
