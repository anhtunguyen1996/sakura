            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="awr-form-title">
                        <?php _e('Avg. Calc From Date',__IT_REPORT_WCREPORT_TEXTDOMAIN__);?>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="awr-form-title">
			            <?php _e('Avg. Calc To Date',__IT_REPORT_WCREPORT_TEXTDOMAIN__);?>
                    </div>
                    <span class="awr-form-icon"><i class="fa fa-calendar"></i></span>
                ...
                <div class="col-md-6">
                    <div class="awr-form-title">
			            <?php _e('Billing Name',__IT_REPORT_WCREPORT_TEXTDOMAIN__);?>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="awr-form-title">
			            <?php _e('Billing Email',__IT_REPORT_WCREPORT_TEXTDOMAIN__);?>
                    </div>
