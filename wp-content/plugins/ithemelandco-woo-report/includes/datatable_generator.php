			...
			public function table_columns($table_name){
				switch($table_name){
					...
					case 'monthly_summary':
						$table_column=array(
							array('lable'=>esc_html__('Month',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Target Sales',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Actual Sales',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Difference',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('%',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('% of Total YR PROJ',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Refund Amt.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Part Refund Amount',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Total Discount Amt.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
//							array('lable'=>esc_html__('Tax Amt.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
//							array('lable'=>esc_html__('Shipping Order Tax',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
//							array('lable'=>esc_html__('Total Shipping Tax',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
					);
					break;

					case 'order_summary':
						$table_column=array(
							array('lable'=>esc_html__('Sales Order',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Order Count',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Amount',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
					);
					break;

					case 'sale_order_status':
						$table_column=array(
							array('lable'=>esc_html__('Order Status',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Order Count',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Amount',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
					);
					break;
					...
					case 'top_5_products':
						$table_column=array(
							array('lable'=>esc_html__('Item Name',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
					...
					case 'top_5_category':
						$table_column=array(
							array('lable'=>esc_html__('Category Name',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Qty',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Amount',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
					);
					break;
					...
					case 'top_5_country':
						$table_column=array(
							array('lable'=>esc_html__('Billing Country',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Order Count',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Amount',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
					);
					break;
					...
					case 'top_5_customer':
						$table_column=array(
							array('lable'=>esc_html__('Billing Name',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Billing Email',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Order Count',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Amount',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
					);
					break;
					...
					case 'top_5_coupon':
						$table_column=array(
							...
							array('lable'=>esc_html__('Coupon Used Count',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Amount',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
					);
					break;
					...
					case 'recent_5_order':
						$table_column=array(
							...
							array('lable'=>esc_html__('Gross Amt.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Order Discount Amt.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Cart Discount Amt.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Total Discount Amt.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Shipping Amt..',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Shipping Tax Amt.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Order Tax Amt.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Total Tax Amt.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Part Refund Amt.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Net Amt.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
						);
					break;
					...
					case 'clinic':
					    $table_column=array(
                            array('lable'=>esc_html__('Clinic Abbreviation',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
                            array('lable'=>esc_html__('Number of Sales',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
                            array('lable'=>esc_html__('Total Amount',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
                        );
						break;
					...
					case 'details_tickera':
						...
						$table_column=array(
							...
							array('lable'=>esc_html__('Date',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Amount',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Change Status Date',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Status.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
						);
					//CUSTOM WORK - 4186
					case 'details_full' :
					...
					case 'brand':
						$table_column=array(
							array('lable'=>esc_html__('Brand Name',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Quantity',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Amount',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
						);
					break;
					...
					case 'order_per_country' :
						$table_column=array(
							...
							array('lable'=>esc_html__('Number of Items sold',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Net Sale',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
                            array('lable'=>esc_html__('Coupon',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
							array('lable'=>esc_html__('Shipping',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
							array('lable'=>esc_html__('Refunds',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
                            array('lable'=>esc_html__('Finaly Sale Amt.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
						);
					break;
					...
					case 'order_per_custom_shipping' :
						$table_column=array(
							array('lable'=>esc_html__('Shipping Address',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Number of Items sold',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Net Sale',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
						);
					break;
					...
					case 'product':
						$table_column=array(
							...
							array('lable'=>esc_html__('Categories',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Tags',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Sales Qty.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Current Stock',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Amount',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
					...
					case 'all_products':
					$table_column=array(
						array('lable'=>esc_html__('Product ID',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
						array('lable'=>esc_html__('Product SKU',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
						array('lable'=>esc_html__('Product Name',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
						array('lable'=>esc_html__('Price',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
						array('lable'=>esc_html__('Category',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
						array('lable'=>esc_html__('Tag',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
						array('lable'=>esc_html__('Sales Qty.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
						array('lable'=>esc_html__('Current Stock',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
						array('lable'=>esc_html__('Amount',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
						array('lable'=>esc_html__('C.O.G',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
						array('lable'=>esc_html__('Profit',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
						//array('lable'=>esc_html__('Edit',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
				);
				break;
					...
					case 'profit':
						$table_column=array(
							...
							array('lable'=>esc_html__('C.O.G',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
							array('lable'=>esc_html__('Profit',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
							//array('lable'=>esc_html__('Avg Profit/Order',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
						);
					break;
					...
					case 'tags':
						$table_column=array(
							array('lable'=>esc_html__('Tag Name',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Quantity',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Amount',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
							array('lable'=>esc_html__('C.O.G',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
							array('lable'=>esc_html__('Profit',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
					...
					case 'customer':
						$table_column=array(
							array('lable'=>esc_html__('Billing First Name',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Billing Last Name',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Billing Email',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Order Count',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Amount',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency')
						);
					...
					case 'customer_role_total_sale':
						$table_column=array(
							array('lable'=>esc_html__('Role Name',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
//							array('lable'=>esc_html__('User Name',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
//							array('lable'=>esc_html__('Email',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Order Count',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Amount',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency')
						);
					...
					case 'customer_role_registered':
						$table_column=array(
							array('lable'=>esc_html__('User Name',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('User Email',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Role Name',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('First Order',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('First Order Date',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('First Order Amount',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
						);
						break;
					case 'customer_role_top_products':
						$table_column=array(
							array('lable'=>esc_html__('Product Name',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Total Sales Qty',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Total Amt.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
						);
						break;
					case 'customer_role_bottom_products':
						$table_column=array(
					...
					case 'taxreport':
						$table_column=array(
							...
							array('lable'=>esc_html__('Tax Rate',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Order Count',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Shipping Amt.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
							//array('lable'=>esc_html__('Gross Amt.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
							array('lable'=>esc_html__('Net Amt.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
							array('lable'=>esc_html__('Shipping Tax',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
							array('lable'=>esc_html__('Order Tax',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
							array('lable'=>esc_html__('Total Tax',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
					...
					case 'customerbuyproducts':
						$table_column=array(
							...
							array('lable'=>esc_html__('Customer Email',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							//4103
							array('lable'=>esc_html__('Customer Phone',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Product Name',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Sales Qty.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Current Stock',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Amount',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
					...
					case 'customer_category':
						$table_column=array(
							array('lable'=>esc_html__('Customer Email',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Customer Name',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Product Category',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Sales Qty.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Amount',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
					);
					break;
					...
					case 'refunddetails_status_refunded_main':
						$table_column=array(
							array('lable'=>esc_html__('Order ID',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Order Date',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Order Status',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Order Counts',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Refund Amount',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
					);
					break;

					case 'refunddetails_status_refunded':
						$table_column=array(
							array('lable'=>esc_html__('Refunded By',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Order Counts',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Refund Amount',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
					);
					break;
					...
					case 'refunddetails_status_daily':
						$table_column=array(
							array('lable'=>esc_html__('Refund Date',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Order Counts',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Refund Amount',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
					);
					break;
					...
					case 'refunddetails_status_yearly':
						$table_column=array(
							array('lable'=>esc_html__('Year',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Order Counts',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Refund Amount',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
					);
					break;
					...
					case 'refunddetails_part_refunded_main':
						$table_column=array(
							array('lable'=>esc_html__('Refund ID',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Refund Date',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Refund Status',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Refund By',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Order ID',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Order Date',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Order Status',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Refund Note',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Refund Amount',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
					);
					break;
					...
					case 'refunddetails_part_refunded_order_id':
						$table_column=array(
							...
							array('lable'=>esc_html__('Order Date',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Order Status',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Refund Counts',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Refund Amount',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
					);
					break;
					...
					case 'coupon':
						$table_column=array(
							array('lable'=>esc_html__('Coupon Code',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Coupon Count',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Coupon Amount',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
					);
					break;
					...
					case 'coupon_discount':
						$table_column=array(
							array('lable'=>esc_html__('Product Name',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Coupon Code',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Discount Type',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Qty',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Discount Amount',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
						);
					break;
					case 'customer_analysis':
						$table_column=array(
							array('lable'=>esc_html__('Months',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Total Sales Amt.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
							array('lable'=>esc_html__('Total Order Count',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('New Customer Count',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Repeat Customer Count',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('New Customer Sales Amt.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
							array('lable'=>esc_html__('Repeat Customer Sales Amt.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
						);
					break;
					case 'customer_order_frequently':
						$table_column=array(
							array('lable'=>esc_html__('Report Item',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
						);
					break;
					case 'customer_min_max':
						$table_column=array(
							...
							array('lable'=>esc_html__('Billing Last Name',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Billing Email',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Min Price',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
							array('lable'=>esc_html__('Max Price',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
							array('lable'=>esc_html__('Order Count',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
						);
					break;
					case 'customer_no_purchased':
						$table_column=array(
							...
							array('lable'=>esc_html__('Billing Email',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Amount',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
							array('lable'=>esc_html__('Last Order Date',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							//array('lable'=>esc_html__('Wake Up',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
						);
					break;
					...
					case 'stock_zero_level' :
						$table_column=array(
							array('lable'=>esc_html__('Product SKU',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Product Name',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Last Sales Date',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Stock Qty.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Actions',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
						);
					break;
					...
					case 'order_product_analysis' :
						$table_column=array(
							...
							array('lable'=>esc_html__('Category',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Product Name',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Number of Order.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Qty.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Price',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
							array('lable'=>esc_html__('Total',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
						);
					break;
					case 'order_variation_analysis' :
						$table_column=array(
					...
					case 'country_per_month':
						$table_column=array(
							array('lable'=>esc_html__('Country Name',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
					);
					break;
					case 'payment_per_month':
						$table_column=array(
							array('lable'=>esc_html__('Payment Gateway',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),

					);
					break;
					case 'ord_status_per_month':
						$table_column=array(
							array('lable'=>esc_html__('Status Name',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),

					);
					break;
					case 'summary_per_month':
						$table_column=array(
							array('lable'=>esc_html__('Reports',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
						);
					break;
					//end of cross tabs
					...
					case 'projected_actual_sale':
						$table_column=array(
							array('lable'=>esc_html__('Month',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Target Sales',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
							array('lable'=>esc_html__('Actual Sales',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
							array('lable'=>esc_html__('Difference',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
							array('lable'=>esc_html__('%',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
							array('lable'=>esc_html__('Refund Amt.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
							array('lable'=>esc_html__('Part Refund Amount',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
							array('lable'=>esc_html__('Total Discount Amt.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
					);
					break;
					...
					case 'product_variation_qty':
						$table_column=array(
							array('lable'=>esc_html__('Simple Product',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Qty',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('*',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
				...
				switch($table_name){
					...
					case 'details_no_items':
						$table_column=array(
							array('lable'=> esc_html__('Order Count',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=> esc_html__('Gross Amt.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>	esc_html__('Discount Amt.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>	esc_html__('Shipping Amt.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>	esc_html__('Shipping Tax Amt.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>	esc_html__('Order Tax Amt.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=> esc_html__('Total Tax Amt.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=> esc_html__('Part Refund Amt.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=> esc_html__('Net Amt.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('C.O.G Amt.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Profit Amt.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
						);
						break;
					...
					case 'details_with_items':
						$table_column=array(
							array('lable'=> esc_html__('Order Count',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=> esc_html__('Product Count',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=> esc_html__('Qty.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=> esc_html__('Rate',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=> esc_html__('Prod. Amt.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=> esc_html__('Prod. Discount',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=> esc_html__('Net Amt.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('C.O.G Amt.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Profit Amt.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
						);
					...
					case 'brand':
						$table_column=array(
							array('lable'=>esc_html__('Brand Count',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Sales Qty.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Total Amount',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
						);
						break;
					...
					case 'custom_taxonomy':
						$table_column=array(
							array('lable'=>esc_html__('Category Count',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Sales Qty.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Total Amount',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
						);
						break;
					...
					case 'order_per_country' :
						$table_column=array(
							array('lable'=>esc_html__('Country Count',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Number of Items sold',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Net Sale',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
							array('lable'=>esc_html__('Coupon Amt.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
							array('lable'=>esc_html__('Shipping Amt.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
							array('lable'=>esc_html__('Refunds Amt.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
							array('lable'=>esc_html__('Finaly Sale Amt.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
						);
						break;
					...
					case 'product':
						$table_column=array(
							...
							array('lable'=>esc_html__('Sales Qty.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Total Amount',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('C.O.G Amt.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
							array('lable'=>esc_html__('Profit Amt.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
						);
						break;
						...
						case 'all_products':
						$table_column=array(
							array('lable'=>esc_html__('Variation Count',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Sales Qty.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Amount',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
							array('lable'=>esc_html__('C.O.G Amt.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
							array('lable'=>esc_html__('Profit Amt.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
					...
					case 'customer':
						$table_column=array(
							array('lable'=>esc_html__('Customer Count',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Order Count',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Total Amount',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency')
						);
						break;
					...
					case 'billingstate':
						$table_column=array(
							array('lable'=>esc_html__('Billing State Count',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Order Count',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Total Amount',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
						);
						break;
					...
					case 'billingcity':
						$table_column=array(
							array('lable'=>esc_html__('Billing City Count',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Order Count',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Total Amount',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
						);
						break;
					...
					case 'paymentgateway':
						$table_column=array(
							array('lable'=>esc_html__('Payment Method Count',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Order Count',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Total Amount',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
						);
						break;
					...
					case 'orderstatus':
						$table_column=array(
							array('lable'=>esc_html__('Order Status Count',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Order Count',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Total Amount',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
						);
						break;
					...
					case 'taxreport':
						$table_column=array(
							array('lable'=>esc_html__('Tax Count',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Order Count',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Shipping Amt.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							//array('lable'=>esc_html__('Gross Amt.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Net Amt.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Shipping Tax',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Order Tax',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Total Tax',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
						);
						break;
					...
					case 'refunddetails':
						$table_column=array(
							array('lable'=>esc_html__('Result Count',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Order Counts',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Refund Amount',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
						);
						break;
					...
					case 'coupon':
						$table_column=array(
							array('lable'=>esc_html__('Result Count',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Coupon Count',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Coupon Amount',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
						);
						break;
					...
					case 'coupon_discount':
						$table_column=array(
							array('lable'=>esc_html__('Result Count',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Product Qty',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Discount Amount',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
						);
						break;
					case 'customer_analysis':
						$table_column=array(
							array('lable'=>esc_html__('Months Count',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Total Sales Amt.',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
							array('lable'=>esc_html__('Total Order Count',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('New Customer Count',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Repeat Customer Count',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
					...
					case 'customer_min_max':
						$table_column=array(
							array('lable'=>esc_html__('Customer Count',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
							array('lable'=>esc_html__('Order Count',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Total Amount',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
						);
						break;
					...
					case 'stock_zero_level' :
						$table_column=array(
							array('lable'=>esc_html__('Product Count',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Total Stock',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
						);
						break;
					...
					case 'stock_summary_avg' :
						$table_column=array(
							array('lable'=>esc_html__('Product Count',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
							array('lable'=>esc_html__('Current Stock Qty',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
						);
						break;
					//////END STOCK REPORTS/////
			...
			public function table_html($table_name,$search_fields=NULL){
				...
				$page_titles=array(
					'dashboard_report'		=> esc_html__( "Summary",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
					'monthly_summary'		=> esc_html__( "Monthly Summary",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
					'order_summary'			=> esc_html__( "Order Summary",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
					'sale_order_status'		=> esc_html__( "Sales Order Status",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
					'top_5_products'		=> sprintf(esc_html__( "Top %s Products",__IT_REPORT_WCREPORT_TEXTDOMAIN__),$product_count),
					'top_5_country'			=> sprintf(esc_html__( "Top %s Billing Country",__IT_REPORT_WCREPORT_TEXTDOMAIN__),$country_count),
					'top_5_category'		=> sprintf(esc_html__( "Top %s Categroy",__IT_REPORT_WCREPORT_TEXTDOMAIN__),$category_count),
					'top_5_state'			=> sprintf(esc_html__( "Top %s Billing State",__IT_REPORT_WCREPORT_TEXTDOMAIN__),$state_count),
					'top_5_customer'		=> sprintf(esc_html__( "Top %s Customers",__IT_REPORT_WCREPORT_TEXTDOMAIN__),$customer_count),
					'top_5_coupon'			=> sprintf(esc_html__( "Top %s Coupon",__IT_REPORT_WCREPORT_TEXTDOMAIN__),$coupon_count),
					'top_5_gateway'			=> sprintf(esc_html__( "Top %s Payment Gateway",__IT_REPORT_WCREPORT_TEXTDOMAIN__),$gateway_count),
					"recent_5_order"		=> sprintf(esc_html__( "Recent %s Orders",__IT_REPORT_WCREPORT_TEXTDOMAIN__),$order_count),
					'details'				=> esc_html__( "All Orders",__IT_REPORT_WCREPORT_TEXTDOMAIN__),

                    //CUSTOM WORK - 522
                    'details_combined'				=> esc_html__( "Combined Orders",__IT_REPORT_WCREPORT_TEXTDOMAIN__),

					//CUSTOM WORK - 12679
					'clinic'				=> esc_html__( "Total Sales per Clinic",__IT_REPORT_WCREPORT_TEXTDOMAIN__),

                    //CUSTOM WORK - 12300
					'details_tickera'				=> esc_html__( "All Orders Tickera",__IT_REPORT_WCREPORT_TEXTDOMAIN__),

                    //CUSTOM WORK - 4186
					'details_full'				=> esc_html__( "All Orders Billing",__IT_REPORT_WCREPORT_TEXTDOMAIN__),


                    //CUSTOM WORK - 53
					'details_full_shipping'				=> esc_html__( "All Orders Billing/Shipping",__IT_REPORT_WCREPORT_TEXTDOMAIN__),

                    //CUSTOM WORK - 16
					'details_full_shipping_tax'				=> esc_html__( "All Orders Billing|Shipping Tax",__IT_REPORT_WCREPORT_TEXTDOMAIN__),

					//ADDED IN VER 4.9
					'abandoned_cart'				=> esc_html__( "Abandoned Carts",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
					'abandoned_product'				=> esc_html__( "Abandoned Products",__IT_REPORT_WCREPORT_TEXTDOMAIN__),

					//CUSTOM WORK - 4179
					'order_status_change'				=> esc_html__( "Status Change",__IT_REPORT_WCREPORT_TEXTDOMAIN__),

					////ADDED IN VER4.0
                    /// ORDER PER COUNTRY
                    'details_order_country'	=> esc_html__( "All Orders per Country",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
					'order_per_country'		=> esc_html__( "Order / Country",__IT_REPORT_WCREPORT_TEXTDOMAIN__),

					//CUSTOM WORK 15092
					'order_per_custom_shipping'		=> esc_html__( "Order / Shipping",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
					////ADDED IN VER4.0
                    /// PRODUCT OPTIONS CUSTOM FIELDS

					'product'				 => esc_html__( "Product",__IT_REPORT_WCREPORT_TEXTDOMAIN__),

					//CUSTOM WORK 966
					'all_products'				 => esc_html__( "All Products",__IT_REPORT_WCREPORT_TEXTDOMAIN__),

        	'profit'				 => esc_html__( "Profit",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
					'category'				=> esc_html__( "Category",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
					////ADDED IN VER4.0
					'tags'				=> esc_html__( "Tags",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
					'stock_zero_level'				=> esc_html__( "Zero Level Stock",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
					'stock_min_level'				=> esc_html__( "Minimum Level Stock",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
					'stock_max_level'				=> esc_html__( "Most Stocked",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
					'stock_summary_avg'				=> esc_html__( "Summary Stock Planner Based On Average Sales",__IT_REPORT_WCREPORT_TEXTDOMAIN__),

					'customer'				=> esc_html__( "Customer",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
					'billingcountry'		  => esc_html__( "Billing Country",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
					'billingstate'			=> esc_html__( "Billing State",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
					'billingcity'			=> esc_html__( "Billing City",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
					'paymentgateway'		  => esc_html__( "Payment Gateway",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
					'orderstatus'			 => esc_html__( "Order Status",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
					'recentorder'			 => esc_html__( "Recent Order",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
					'taxreport' 			   => esc_html__( "Tax Report",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
					'customerbuyproducts'	 => esc_html__( "Custom Member Buy Products",__IT_REPORT_WCREPORT_TEXTDOMAIN__),

					//CUSTOM WORK
					'customer_category'	 => esc_html__( "Customer Buy Category",__IT_REPORT_WCREPORT_TEXTDOMAIN__),


					'refunddetails' 		   => esc_html__( "Refund Orders",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
					'coupon' 				  => esc_html__( "Coupon",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
					////ADDED IN VER4.0
                    /// OTHER SUMMARY
                    'coupon_discount' 				  => esc_html__( "Coupon Discount Type Reporting",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
					'customer_analysis' 				  => esc_html__( "New Customer/Repeat Customer Analysis",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
					'customer_order_frequently' 	=> esc_html__( "Top n Customer Report Who Orders Frequently",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
					'customer_min_max' 	=> esc_html__( "Customer Min-Max",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
					'customer_no_purchased' 	=> esc_html__( "Customer Who Has Not Purchased",__IT_REPORT_WCREPORT_TEXTDOMAIN__),

					////ADDED IN VER4.0
					/// ORDER ANALYSIS
					'order_product_analysis' 				  => esc_html__( "Order Qty. Analysis Simple",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
					'order_variation_analysis' 				  => esc_html__( "Order Qty. Analysis Variable",__IT_REPORT_WCREPORT_TEXTDOMAIN__),

					'stock_list'			  => esc_html__( "Stock List",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
					'projected_actual_sale'   => esc_html__( "Target Sale vs Actual Sale",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
					'tax_reports'			 => esc_html__( "Tax Reports",__IT_REPORT_WCREPORT_TEXTDOMAIN__),

					//CUSTOM WORK - 12412
					'product_variation_qty'			 => esc_html__( "Product Qty",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
                ...
                <div class="awr-box">
                    <div class="awr-title">
                        <h3>
                            ...
                            <?php
                                //_e('Result',__IT_REPORT_WCREPORT_TEXTDOMAIN__);
			...
			public function table_html_pdf($table_name,$search_fields=NULL,$selected_columns=[]){
				...
				$page_titles=array(
					...
					//CUSTOM WORK - 4186
					'details'				=> esc_html__( "All Orders Billing",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
					...
					////ADDED IN VER4.5
					//CUSTOM WORK
					'product_per_users'				 => esc_html__( "Product/Users",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
					...
					////ADDED IN VER4.0
					/// OTHER SUMMARY
					'coupon_discount' 				  => esc_html__( "Coupon Discount Type Wise Reporting",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
					'customer_analysis' 				  => esc_html__( "New Customer/Repeat Customer Analysis",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
					'customer_order_frequently' 	=> esc_html__( "Top n Customer Report Who Orders Frequently",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
					'customer_min_max' 	=> esc_html__( "Customer Min-Max",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
					'customer_no_purchased' 	=> esc_html__( "Customer Who Has Not Purchased",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
			...
			public function table_html_intelligence($table_name,$search_fields=NULL){
				...
				$page_titles=array(
					'int_reports_Home'		=> esc_html__( "Home",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
					'int_reports_sales'		=> esc_html__( "Intelligence Sales Report",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
					'int_reports_products'		=> esc_html__( "Intelligence Products Report",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
					'int_reports_customers'			=> esc_html__( "Intelligence Customers Report",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
					'int_reports_transactions'			=> esc_html__( "Intelligence Transactions Report",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
                );
			...
			public function it_generate_htmls($params){
				...
				<div class="wrap">
					<div class="awr-box awr-search-from">
						<div class="awr-title">
							<h3>
								<i class="fa fa-filter"></i><?php _e( 'Search', __IT_REPORT_WCREPORT_TEXTDOMAIN__ ); ?>
							</h3>
							<div class="awr-title-icon awr-toggle-icon"><i class="fa fa-search"></i></div>
							<div class="awr-title-icons">
								<div class="awr-title-icon awr-add-fav-icon" title="Add to Favorites Menus" data-smenu="<?php echo $smenu; ?>"><i
											class="fa <?php echo $fav_icon; ?>"></i></div>
...
//return $termlist;
			...
			function it_get_tax_columns($tax_type = 1){
				...
				if($tax_type == 'tax_group_by_city'){
					$columns = array(
						"billing_country"			=>esc_html__("Tax Country",			__IT_REPORT_WCREPORT_TEXTDOMAIN__)
					,"billing_state"			=>esc_html__("Tax State",			__IT_REPORT_WCREPORT_TEXTDOMAIN__)
					,"tax_city"					=>esc_html__("Tax City",			__IT_REPORT_WCREPORT_TEXTDOMAIN__)
					,"tax_rate_name"			=>esc_html__("Tax Name",			__IT_REPORT_WCREPORT_TEXTDOMAIN__)
					,"tax_rate_code"			=>esc_html__("Tax Rate Code",		__IT_REPORT_WCREPORT_TEXTDOMAIN__)
					,"order_tax_rate"			=>esc_html__("Tax Rate",			__IT_REPORT_WCREPORT_TEXTDOMAIN__)
					,"order_count"				=>esc_html__("Order Count",			__IT_REPORT_WCREPORT_TEXTDOMAIN__)
					,"order_shipping"			=>esc_html__("Shipping Amt.",		__IT_REPORT_WCREPORT_TEXTDOMAIN__)
					,"gross_amount"				=>esc_html__("Gross Amt.",			__IT_REPORT_WCREPORT_TEXTDOMAIN__)
					,"order_total"				=>esc_html__("Net Amt.",			__IT_REPORT_WCREPORT_TEXTDOMAIN__)
					,"refund_order_total"		=>esc_html__("Part Refund.",		__IT_REPORT_WCREPORT_TEXTDOMAIN__)
					,"net_order_total"			=>esc_html__("(Net- Refund) Amt.",	__IT_REPORT_WCREPORT_TEXTDOMAIN__)
					,"shipping_tax_amount"		=>esc_html__("Shipping Tax",		__IT_REPORT_WCREPORT_TEXTDOMAIN__)
					,"tax_amount"				=>esc_html__("Order Tax",			__IT_REPORT_WCREPORT_TEXTDOMAIN__)
					,"total_tax"				=>esc_html__("Total Tax",			__IT_REPORT_WCREPORT_TEXTDOMAIN__)
					);
					...
					$columns = array(
						"billing_country"			=>esc_html__("Tax Country",			__IT_REPORT_WCREPORT_TEXTDOMAIN__)
					,"billing_postcode"			=>esc_html__("Tax Zip",				__IT_REPORT_WCREPORT_TEXTDOMAIN__)
					,"tax_rate_name"			=>esc_html__("Tax Name",			__IT_REPORT_WCREPORT_TEXTDOMAIN__)
					,"tax_rate_code"			=>esc_html__("Tax Rate Code",		__IT_REPORT_WCREPORT_TEXTDOMAIN__)
					,"order_tax_rate"			=>esc_html__("Tax Rate",			__IT_REPORT_WCREPORT_TEXTDOMAIN__)
					,"order_count"				=>esc_html__("Order Count",			__IT_REPORT_WCREPORT_TEXTDOMAIN__)
					...
					,"tax_rate_code"			=>esc_html__("Tax Rate Code",		__IT_REPORT_WCREPORT_TEXTDOMAIN__)
					,"order_tax_rate"			=>esc_html__("Tax Rate",			__IT_REPORT_WCREPORT_TEXTDOMAIN__)
						//,"billing_state"			=>esc_html__("Billing State",		__IT_REPORT_WCREPORT_TEXTDOMAIN__)
					,"order_count"				=>esc_html__("Order Count",			__IT_REPORT_WCREPORT_TEXTDOMAIN__)
					,"order_shipping"			=>esc_html__("Shipping Amt.",		__IT_REPORT_WCREPORT_TEXTDOMAIN__)
					,"gross_amount"				=>esc_html__("Gross Amt.",			__IT_REPORT_WCREPORT_TEXTDOMAIN__)
					,"order_total"				=>esc_html__("Net Amt.",			__IT_REPORT_WCREPORT_TEXTDOMAIN__)
				...
				$columns['refund_tax_amount'] 			= esc_html__("Refund Tax",				__IT_REPORT_WCREPORT_TEXTDOMAIN__);
				$columns['refund_shipping_tax_amount'] 	= esc_html__("Refund Shipping Tax",		__IT_REPORT_WCREPORT_TEXTDOMAIN__);
				$columns['total_tax_refund'] 			= esc_html__("Total Tax Refund",		__IT_REPORT_WCREPORT_TEXTDOMAIN__);

				$columns['net_total_tax'] 			= esc_html__("Net Total Tax",		__IT_REPORT_WCREPORT_TEXTDOMAIN__);
...
//echo $sql;
			...
			function it_get_woo_items_sale($type = 'limit_row', $items_only = true, $id = '-1'){
				...
				if($items_only){
					...
					$array = array(
						"0"  => array("item_name"=>esc_html__("Order Total",			__IT_REPORT_WCREPORT_TEXTDOMAIN__),"id"=>"_order_total")
						,"1" => array("item_name"=>esc_html__("Order Tax",				__IT_REPORT_WCREPORT_TEXTDOMAIN__),"id"=>"_order_tax")
						,"2" => array("item_name"=>esc_html__("Order Discount",			__IT_REPORT_WCREPORT_TEXTDOMAIN__),"id"=>"_order_discount")
						,"3" => array("item_name"=>esc_html__("Cart Discount",			__IT_REPORT_WCREPORT_TEXTDOMAIN__),"id"=>"_cart_discount")
						,"4" => array("item_name"=>esc_html__("Order Shipping",			__IT_REPORT_WCREPORT_TEXTDOMAIN__),"id"=>"_order_shipping")
						,"5" => array("item_name"=>esc_html__("Order Shipping Tax",		__IT_REPORT_WCREPORT_TEXTDOMAIN__),"id"=>"_order_shipping_tax")
						,"6" => array("item_name"=>esc_html__("Product Sales",			__IT_REPORT_WCREPORT_TEXTDOMAIN__),"id"=>"_by_product")
					);
...
//					return jsone_encode($products_category);
			...
			function it_woo_so_status($it_shop_order_status = array()){
				...
				$it_shop_order_status = $wpdb->get_results($sql);
...
//echo $sql;
			...
			function it_get_woo_coupons_codes(){
				...
				$it_coupon_codes = $wpdb->get_results($sql);
			...
			function it_get_woo_vd_items(){
				...
				$it_item_attributes =  $wpdb->get_results($sql);
