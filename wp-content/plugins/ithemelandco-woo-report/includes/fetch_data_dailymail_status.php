...
,posts.post_status As 'Status' ,posts.post_status As 'StatusID' FROM {$wpdb->prefix}posts as posts
	...
	$body.='<h1 style="font-size: 18px; color: #fac34f; margin-bottom: 5px">'.$title. " " .esc_html__('Summary -',__IT_REPORT_WCREPORT_TEXTDOMAIN__). " " .$start .date("F d, Y",strtotime($end_date)).'</h1>
	...
	//$body .= '<h3 style="padding:0px; margin:0">'.$title. " " .esc_html__('Summary -',__IT_REPORT_WCREPORT_TEXTDOMAIN__). " " .$start .date("F d, Y",strtotime($end_date)).'</h3>';
	//$body .= '</td>';
	//$body .= '</tr>';

	if($order_data['total_orders_count'] > 0):
		$body .= '<tr>';
		$body .= '<td style="padding: 10px; background-color: #f2f2f2; color: #696969; font-size: 11px;     text-transform: capitalize; border-bottom: 1px solid #ddd;font-weight: bold;">'.esc_html__("Total Sales:",__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</td>';
	...
	if($order_data['total_sales_amount'] > 0):
		$body .= '<tr>';
		$body .= '<td style="padding: 10px; background-color: #f2f2f2; color: #696969; font-size: 11px;     text-transform: capitalize; border-bottom: 1px solid #ddd;font-weight: bold;">'.esc_html__("Total Sales Amount:",__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</td>';
	...
	if(isset($order_items_discount->ItemCount) and $order_items_discount->ItemCount > 0):
		$body .= '<tr>';
		$body .= '<td style="padding: 10px; background-color: #f2f2f2; color: #696969; font-size: 11px;     text-transform: capitalize; border-bottom: 1px solid #ddd;font-weight: bold;">'.esc_html__("Discount Amount:",__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</td>';
	...
	if(isset($order_items_discount->total_count) and $order_items_coupon->total_count > 0):
		$body .= '<tr>';
		$body .= '<td style="padding: 10px; background-color: #f2f2f2; color: #696969; font-size: 11px;     text-transform: capitalize; border-bottom: 1px solid #ddd;font-weight: bold;">'.esc_html__("Coupon Amount:",__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</td>';
	...
	if(isset($order_items->total_count) and $order_items->total_count > 0):
		$body .= '<tr>';
		$body .= '<td style="padding: 10px; background-color: #f2f2f2; color: #696969; font-size: 11px;     text-transform: capitalize; border-bottom: 1px solid #ddd;font-weight: bold;">'.esc_html__("Refund Amount:",__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</td>';
	...
	if(isset($order_items_shipping_tax->total_count) and $order_items_shipping_tax->total_count > 0):
		$body .= '<tr>';
		$body .= '<td style="padding: 10px; background-color: #f2f2f2; color: #696969; font-size: 11px;     text-transform: capitalize; border-bottom: 1px solid #ddd;font-weight: bold;">'.esc_html__("Shipping Tax Amount:",__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</td>';
	...
	if(isset($order_items_tax->total_count) and $order_items_tax->total_count > 0):
		$body .= '<tr>';
		$body .= '<td style="padding: 10px; background-color: #f2f2f2; color: #696969; font-size: 11px;     text-transform: capitalize; border-bottom: 1px solid #ddd;font-weight: bold;">'.esc_html__("Order Tax Amount:",__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</td>';
	...
	if(isset($order_items_tax->total_count) and $order_items_shipping_tax->total_count > 0):
		$body .= '<tr>';
		$body .= '<td style="padding: 10px; background-color: #f2f2f2; color: #696969; font-size: 11px;     text-transform: capitalize; border-bottom: 1px solid #ddd;font-weight: bold;">'.esc_html__("Total Tax Amount:",__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</td>';
		$body .= '<td style="padding: 10px; background-color: #f2f2f2; color: #909090; font-size: 11px;     text-transform: capitalize; border-bottom: 1px solid #ddd;">&nbsp; &nbsp; &nbsp; </td>';
	...
	if($shipping_amount > 0):
		$body .= '<tr>';
		$body .= '<td style="padding: 10px; background-color: #f2f2f2; color: #696969; font-size: 11px;     text-transform: capitalize; border-bottom: 1px solid #ddd;font-weight: bold;">'.esc_html__("Shipping Amount:",__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</td>';
		$body .= '<td style="padding: 10px; background-color: #f2f2f2; color: #909090; font-size: 11px;     text-transform: capitalize; border-bottom: 1px solid #ddd;">&nbsp; &nbsp; &nbsp; </td>';
	...
	if(isset($order_data['total_sales_avg_amount']) and $order_data['total_sales_avg_amount'] > 0):
		$body .= '<tr>';
		$body .= '<td style="padding: 10px; background-color: #f2f2f2; color: #696969; font-size: 11px;     text-transform: capitalize; border-bottom: 1px solid #ddd;font-weight: bold;">'.esc_html__("Average Sales:",__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</td>';
		$body .= '<td style="padding: 10px; background-color: #f2f2f2; color: #909090; font-size: 11px;     text-transform: capitalize; border-bottom: 1px solid #ddd;">&nbsp; &nbsp; &nbsp; </td>';
	...
	$today_customer_count = $this->it_today_total_customer($start_date, $end_date);
	if($today_customer_count > 0):
		$body .= '<tr>';
		$body .= '<td style="padding: 10px; background-color: #f2f2f2; color: #696969; font-size: 11px;     text-transform: capitalize; border-bottom: 1px solid #ddd;font-weight: bold;">'.esc_html__("New Customer:",__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</td>';
	...
	if($order_items_status and count($order_items_status)>0):
		$body .= '<tr>';
		//$body .= "\n";
		$body .= '<td colspan="3" style="padding:3px 6px; background:#d3d3d3; width:100%; font-size:13px;"><b>'.esc_html__("Order Status",__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</b></td>';
		//$body .= "\n";
		$body .= '</tr>';
