...
class IT_Cart_Index_Page
{
    public function __construct()
    {
        ...
        add_action('views_edit-carts', array($this,'it_remove_cart_views' )); //Remove the All / Published / Trash view.
        add_action('manage_carts_posts_custom_column', array($this,'it_manage_cart_columns'), 1, 1);
        ...
        add_filter('manage_edit-carts_columns', array($this,'it_carts_columns' )) ;
        add_filter('manage_edit-carts_sortable_columns', array($this,'it_carts_sort'));
    ...
    */
    ...
    /*
    *
    * it_carts_columns( $columns )
    *
    * Rename Columns for the new "Cart" post type
    */

    public function it_carts_columns($columns)
    {
    ...
    */
    ...
    public function it_carts_sort($columns)
    {
        $custom = array(
    ...
    */
    ...
    /*
    *
    * it_remove_cart_views( $views )
    *
    * Remove drag-over action items on carts page
    *
    */

    public function it_remove_cart_views($views)
    {
        unset($views['all']);
        unset($views['publish']);
        unset($views['trash']);
    ...
    /*
    *
    * it_manage_cart_columns( $column, $post_id )
    *
    * Add cases for our custom columns (status, updated, actions)
    *
    */

    public function it_manage_cart_columns($column, $post_id ='')
    {
        global $post;
    ...
    case 'cartname':
        ...
        case 'products':
            ...
            $cartitems = get_post_meta($post->ID, 'it_cartitems', true);
