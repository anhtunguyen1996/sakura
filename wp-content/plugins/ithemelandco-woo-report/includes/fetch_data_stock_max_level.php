<?php
	...
	if($file_used=="sql_table")
	{
		...
		$it_stock_greate_than		= $this->it_get_woo_requests('it_stock_greate_than',"0",true);
		...
		$sql_condition .= " AND it_stock.meta_value > {$it_stock_greate_than}";

		$sql_group_by = " GROUP BY product_id ";

		$sql_order_by = " ORDER BY it_stock.meta_value *1 DESC ";
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="awr-form-title">
	                    <?php _e('Stock Greater Than',__IT_REPORT_WCREPORT_TEXTDOMAIN__);?>
                    </div>
                    <span class="awr-form-icon"><i class="fa fa-battery-4"></i></span>
                    <input name="it_stock_greate_than" type="text" class="it_stock_greate_than" value="2"/>
                </div>
