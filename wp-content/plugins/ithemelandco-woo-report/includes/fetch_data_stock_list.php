	...
	if($file_used=="sql_table")
	{
		...
		if($it_basic_column=='yes'){
			...
			$columns=array(
				...
				array('lable'=>esc_html__('Stock',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
			);
			...
			$columns=array(
				array('lable'=>esc_html__('SKU',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
				array('lable'=>esc_html__('Product Name',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
				array('lable'=>esc_html__('Product Type',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
				array('lable'=>esc_html__('Category',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),

				array('lable'=>esc_html__('Created Date',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
				array('lable'=>esc_html__('Modified Date',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
				array('lable'=>esc_html__('Stock',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
				array('lable'=>esc_html__('Regular Price',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),
				array('lable'=>esc_html__('Sale Price',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'currency'),

				array('lable'=>esc_html__('Downloadable',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
				array('lable'=>esc_html__('Virtual',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
				array('lable'=>esc_html__('Manage Stock',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
				array('lable'=>esc_html__('Backorders',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
				array('lable'=>esc_html__('Stock Status',__IT_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show')
			);
		...
		//for($i=1; $i<=20 ; $i++){
			...
			if($it_basic_column=='yes'){
				...
				//Stock Status
				$it_stock_status = array("instock" => esc_html__("In stock",__IT_REPORT_WCREPORT_TEXTDOMAIN__), "outofstock" => esc_html__("Out of stock",__IT_REPORT_WCREPORT_TEXTDOMAIN__));
		...
		<form class='alldetails search_form_report' action='' method='post'>
            ...
            <div class="row">
	            ...
	            if(is_array(__CUSTOMWORK_ID__) && in_array('15862',__CUSTOMWORK_ID__)){
                    ...
                    <div class="col-md-6">
                        <div class="awr-form-title">
				            <?php _e('Custom SKU',__IT_REPORT_WCREPORT_TEXTDOMAIN__);?>
                        </div>
