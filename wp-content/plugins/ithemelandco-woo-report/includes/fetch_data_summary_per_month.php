		...
		<form class='alldetails search_form_report' action='' method='post'>
			...
			<div class="row">
				...
				<div class="col-md-6">
             	...
             	<div class="col-md-6">
                	<div class="awr-form-title">
						<?php _e('Reports',__IT_REPORT_WCREPORT_TEXTDOMAIN__);?>
                    </div>
					<span class="awr-form-icon"><i class="fa fa-flag"></i></span>
					<?php
                        $reports = array(
                            "0"=>esc_html__("Order Total",				__IT_REPORT_WCREPORT_TEXTDOMAIN__),
                            "1"=>esc_html__("Order Tax",				__IT_REPORT_WCREPORT_TEXTDOMAIN__),
                            "2"=>esc_html__("Order Discount",			__IT_REPORT_WCREPORT_TEXTDOMAIN__),
                            "3"=>esc_html__("Cart Discount",			__IT_REPORT_WCREPORT_TEXTDOMAIN__),
                            "4"=>esc_html__("Order Shipping",			__IT_REPORT_WCREPORT_TEXTDOMAIN__),
                            "5"=>esc_html__("Order Shipping Tax",		__IT_REPORT_WCREPORT_TEXTDOMAIN__),
                            "6"=>esc_html__("Product Sales",			__IT_REPORT_WCREPORT_TEXTDOMAIN__)
                        );
