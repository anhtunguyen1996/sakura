<?php
	...
	if($file_used=="sql_table")
	{
		...
		if(strlen($it_stock_less_than) > 0){
			$sql_condition .= " AND (it_stock.meta_value <= {$it_stock_less_than} AND it_stock.meta_value >= 1)";
		}else{
			$sql_condition .= " AND (it_stock.meta_value <= 2 AND it_stock.meta_value >= 1)";
		}
		...
		<form class='alldetails search_form_report' action='' method='post'>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <input name="it_stock_less_than" type="text" class="it_stock_less_than" value="2"/>
                </div>
