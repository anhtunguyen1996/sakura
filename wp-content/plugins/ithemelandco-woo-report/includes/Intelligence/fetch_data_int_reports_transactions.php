            ...
            <div class="int-awr-box pw-center-align pw-pr-sum-box">
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="pw-box-padder">
                        ...
                        <div class="pw-val pwl-lbl">'.esc_html__('TAX',__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</div>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="pw-box-padder">
                        ...
                        <div class="pw-val pwl-lbl">'.esc_html__('TOTAL AMOUNT',__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</div>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="pw-box-padder">
                        ...
                        <div class="pw-val pwl-lbl">'.esc_html__('TRANSACTIONS',__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</div>
                    </div>
                </div>
            </div>
        </div>';
