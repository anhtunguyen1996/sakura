<?php
    ...
    elseif($file_used=="data_table"){
	    ...
	    $percentage_down_up_html='
            <span class="pw-val pw-sm-font">'.esc_html__('Up by',__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</span>
        ...
        if($net_amnt_last_x_days!=0){
            ...
            if($net_amnt>$net_amnt_last_x_days){
	            ...
	            $percentage_down_up_html='
	                <span class="pw-val pw-sm-font">'.esc_html__('down by',__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</span>
...
//	            }
        ...
        <div class="col-xs-12 col-md-6">
            <div class="int-awr-box pw-main-box">
                <div class="awr-title">
                    <h3>
                        <i class="fa fa-money"></i>'.esc_html__('Sales',__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</h3>
        ...
        <div class="col-xs-12 col-md-6">
            <div class="int-awr-box pw-main-box">
                <div class="awr-title">
                    <h3>
                        <i class="fa fa-map-marker"></i>'.esc_html__('Sales heatmap',__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</h3>
                    <div class="awr-title-icons">

                        <div class="awr-title-icon awr-add-fav-icon awr-tooltip-wrapper" data-smenu="all_orders">
                            <i class="fa  fa-info "></i>
                            <div class="awr-tooltip-cnt">
                                <div class="awr-tooltip-header">'.esc_html__('Sales heatmap',__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</div>
                                <div class="awr-tooltip-content">'.esc_html__('Identify which is the most profitable day, time when your store makes a sale. Darker the spots, more the sales.',__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</div>
                            </div>
                        </div>
                        <div class="awr-title-icon awr-setting-icon" style="display: none;"><i class="fa fa-cog"></i></div>
                        <div class="awr-title-icon awr-close-icon" style="display: none;"><i class="fa fa-times"></i></div>
                        ...
                        <table class="display datatable intelligence_customer_datatable dataTable no-footer" cellspacing="0" width="100%" id="DataTables_Table_1" role="grid" aria-describedby="DataTables_Table_1_info" style="width: 100%;">
                            <thead>
                                <tr role="row">
                                    ...
                                    <th style="width: 281px;" data-class="" class="sorting_disabled" rowspan="1" colspan="1"><div>'.esc_html__('Date',__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</div></th>
                                    <th style="width: 224px;" data-class="" class="sorting_disabled" rowspan="1" colspan="1"><div>'.esc_html__('Customer',__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</div></th>
                                    <th style="width: 142px;" data-class="" class="sorting_disabled" rowspan="1" colspan="1"><div>'.esc_html__('Amount',__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</div></th></tr>
                            </thead>
        ...
        <div class="col-xs-12 col-md-8" id="it_intelligence_customer_details">
