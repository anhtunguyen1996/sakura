<?php
    ...
    if($img_url==''){
	    $img_url=__IT_REPORT_WCREPORT_URL__ .'/assets/images/no_image.jpg';
    }
    ...
    $it_order_status=$it_rpt_main_class->it_shop_status;
    $it_order_status  		= "'".str_replace(",","','",$it_order_status)."'";

    //////////////////////////////////////////////////////
	//FETCH FREQUENTLY BOUGHT TOGETHER
    //////////////////////////////////////////////////////
	$sql_order_products="SELECT DATE_FORMAT(it_posts.post_date,'%m/%d/%Y') AS order_date,DATE(it_posts.post_date) AS post_date, it_woocommerce_order_items.order_id AS order_id, woocommerce_order_itemmeta.meta_value AS woocommerce_order_itemmeta_meta_value,  woocommerce_order_itemmeta.meta_value AS product_id,  woocommerce_order_itemmeta_v.meta_value AS variation_id	,it_posts.post_status AS post_status FROM {$wpdb->prefix}woocommerce_order_items as it_woocommerce_order_items LEFT JOIN {$wpdb->prefix}posts as it_posts ON it_posts.ID=it_woocommerce_order_items.order_id	LEFT JOIN {$wpdb->prefix}woocommerce_order_itemmeta as woocommerce_order_itemmeta ON woocommerce_order_itemmeta.order_item_id	= it_woocommerce_order_items.order_item_id LEFT JOIN {$wpdb->prefix}woocommerce_order_itemmeta as woocommerce_order_itemmeta_v ON woocommerce_order_itemmeta_v.order_item_id	= it_woocommerce_order_items.order_item_id   Where it_posts.post_type = 'shop_order' AND woocommerce_order_itemmeta.meta_key = '_product_id' AND woocommerce_order_itemmeta_v.meta_key = '_variation_id' AND DATE(it_posts.post_date) BETWEEN '$it_from_date' AND '$it_to_date' AND it_posts.post_status IN ($it_order_status) AND it_posts.post_status NOT IN ('trash') ORDER BY post_date DESC";
    ...
    //////////////////////////////////////////////////////
    $sql_int_customer_products="SELECT it_woocommerce_order_items.order_item_name	AS 'product_name' ,it_woocommerce_order_items.order_item_id	AS order_item_id ,SUM(woocommerce_order_itemmeta.meta_value)	AS 'quantity' ,SUM(it_woocommerce_order_itemmeta6.meta_value)	AS 'total_amount' ,it_woocommerce_order_itemmeta7.meta_value	AS product_id ,it_woocommerce_order_itemmeta_v.meta_value	AS product_id ,it_postmeta_customer_user.meta_value	AS customer_id ,DATE(it_posts.post_date) AS post_date ,it_postmeta_billing_billing_email.meta_value	AS billing_email ,CONCAT(it_postmeta_billing_billing_email.meta_value,' ',it_woocommerce_order_itemmeta7.meta_value,' ',it_postmeta_customer_user.meta_value)	AS group_column ,CONCAT(it_postmeta_billing_first_name.meta_value,' ',postmeta_billing_last_name.meta_value)	AS billing_name,it_postmeta_billing_country.meta_value	AS billing_country	FROM wp_woocommerce_order_items as it_woocommerce_order_items	LEFT JOIN wp_woocommerce_order_itemmeta as woocommerce_order_itemmeta ON woocommerce_order_itemmeta.order_item_id=it_woocommerce_order_items.order_item_id LEFT JOIN wp_woocommerce_order_itemmeta as it_woocommerce_order_itemmeta6 ON it_woocommerce_order_itemmeta6.order_item_id=it_woocommerce_order_items.order_item_id LEFT JOIN wp_woocommerce_order_itemmeta as it_woocommerce_order_itemmeta7 ON it_woocommerce_order_itemmeta7.order_item_id=it_woocommerce_order_items.order_item_id LEFT JOIN wp_woocommerce_order_itemmeta as it_woocommerce_order_itemmeta_v ON it_woocommerce_order_itemmeta_v.order_item_id=it_woocommerce_order_items.order_item_id	LEFT JOIN wp_posts as it_posts ON it_posts.id=it_woocommerce_order_items.order_id LEFT JOIN {$wpdb->prefix}postmeta  as it_postmeta_billing_first_name ON it_postmeta_billing_first_name.post_id	=	it_woocommerce_order_items.order_id LEFT JOIN {$wpdb->prefix}postmeta  as postmeta_billing_last_name ON postmeta_billing_last_name.post_id	= it_woocommerce_order_items.order_id LEFT JOIN {$wpdb->prefix}postmeta  as it_postmeta_billing_billing_email ON it_postmeta_billing_billing_email.post_id	= it_woocommerce_order_items.order_id LEFT JOIN {$wpdb->prefix}postmeta  as it_postmeta_billing_country ON it_postmeta_billing_country.post_id	= it_woocommerce_order_items.order_id LEFT JOIN {$wpdb->prefix}postmeta  as it_postmeta_customer_user ON it_postmeta_customer_user.post_id	= it_woocommerce_order_items.order_id WHERE woocommerce_order_itemmeta.meta_key	= '_qty' AND it_woocommerce_order_itemmeta6.meta_key	= '_line_total' AND it_woocommerce_order_itemmeta7.meta_key = '_product_id' AND it_woocommerce_order_itemmeta_v.meta_key = '_product_id' AND it_postmeta_billing_first_name.meta_key	= '_billing_first_name' AND postmeta_billing_last_name.meta_key	= '_billing_last_name' AND it_postmeta_billing_billing_email.meta_key	= '_billing_email' AND it_postmeta_billing_country.meta_key	= '_billing_country' AND it_postmeta_customer_user.meta_key	= '_customer_user' AND DATE(it_posts.post_date) BETWEEN '$it_from_date' AND '$it_to_date' AND it_posts.post_status IN ($it_order_status) AND it_posts.post_status NOT IN ('trash') GROUP BY group_column ORDER BY post_date DESC
";
	...
	$sss="SELECT it_posts.ID as order_id,it_posts.post_status, (it_postmeta1.meta_value) AS 'total_amount' ,it_postmeta2.meta_value AS 'billing_email' ,(it_postmeta2.meta_value) AS 'order_count' ,it_postmeta4.meta_value AS customer_id FROM wp_posts as it_posts LEFT JOIN {$wpdb->prefix}postmeta  as it_postmeta1 ON it_postmeta1.post_id=it_posts.ID LEFT JOIN {$wpdb->prefix}postmeta  as it_postmeta2 ON it_postmeta2.post_id=it_posts.ID LEFT JOIN {$wpdb->prefix}postmeta  as it_postmeta4 ON it_postmeta4.post_id=it_posts.ID WHERE it_posts.post_type='shop_order' AND it_postmeta1.meta_key='_order_total' AND it_postmeta2.meta_key='_billing_email' AND it_postmeta4.meta_key='_customer_user' AND DATE(it_posts.post_date) BETWEEN '$it_from_date' AND '$it_to_date' AND it_posts.post_status IN ($it_order_status) AND it_posts.post_status NOT IN ('trash') /*GROUP BY it_postmeta2.meta_value*/ Order By total_amount DESC
";
    ...
    foreach($order_items_ss as $items){
        ...
        $total_amount= $items_total_amunt == 0 ? $it_rpt_main_class->price(0) : $it_rpt_main_class->price($items_total_amunt);
	...
	foreach($arr_p as $p_id => $with_product){
		...
		if($img_urls==''){
			$img_urls=__IT_REPORT_WCREPORT_URL__ .'/assets/images/no_image.jpg';
		}
	...
	if($with_product_html!=''){
		$with_product_html='<div class="pw-val pw-sm-font pw-frequency-together">'.esc_html__('FREQUENTLY BOUGHT TOGETHER',__IT_REPORT_WCREPORT_TEXTDOMAIN__).' 

<div class="awr-title-icon awr-add-fav-icon awr-tooltip-wrapper" data-smenu="all_orders">
                                <i class="fa fa-info-circle"></i>
                                <div class="awr-tooltip-cnt">
                                    <div class="awr-tooltip-header">'.esc_html__('Frequently Bought Together',__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</div>
                                    <div class="awr-tooltip-content">'.esc_html__('Customers who purchased \'Web Entrepreneurs\' Club - Annual\' also bought these products.',__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</div>
                                </div>
                            </div>
	...
	$month_week_title=esc_html__('MONTH',__IT_REPORT_WCREPORT_TEXTDOMAIN__);
	$month_week_titles=esc_html__('MONTHS',__IT_REPORT_WCREPORT_TEXTDOMAIN__);
	if($days<=7) {
		$month_week_title=esc_html__('WEEK',__IT_REPORT_WCREPORT_TEXTDOMAIN__);
		$month_week_titles=esc_html__('WEEKS',__IT_REPORT_WCREPORT_TEXTDOMAIN__);
	...
	foreach($months_weeks_array_range as $index => $month){
		$sql="SELECT shop_order.ID as order_id,shop_order.post_status, it_woocommerce_order_items.order_item_name	AS 'product_name' ,it_woocommerce_order_items.order_item_id	AS order_item_id ,it_woocommerce_order_itemmeta7.meta_value	AS product_id ,DATE(shop_order.post_date)	AS post_date ,(woocommerce_order_itemmeta.meta_value) AS 'quantity' ,(it_woocommerce_order_itemmeta6.meta_value) AS 'total_amount' FROM {$wpdb->prefix}woocommerce_order_items as it_woocommerce_order_items	LEFT JOIN {$wpdb->prefix}woocommerce_order_itemmeta as woocommerce_order_itemmeta ON woocommerce_order_itemmeta.order_item_id=it_woocommerce_order_items.order_item_id LEFT JOIN {$wpdb->prefix}woocommerce_order_itemmeta as it_woocommerce_order_itemmeta6 ON it_woocommerce_order_itemmeta6.order_item_id=it_woocommerce_order_items.order_item_id LEFT JOIN {$wpdb->prefix}woocommerce_order_itemmeta as it_woocommerce_order_itemmeta7 ON it_woocommerce_order_itemmeta7.order_item_id=it_woocommerce_order_items.order_item_id	LEFT JOIN {$wpdb->prefix}posts as shop_order ON shop_order.id=it_woocommerce_order_items.order_id WHERE 1*1 AND woocommerce_order_itemmeta.meta_key	= '_qty' AND it_woocommerce_order_itemmeta6.meta_key	= '_line_total'	AND (it_woocommerce_order_itemmeta7.meta_key = '_product_id' or it_woocommerce_order_itemmeta7.meta_key = '_variation_id') AND it_woocommerce_order_itemmeta7.meta_value='$product_id' AND shop_order.post_type	= 'shop_order' AND (DATE(shop_order.post_date) BETWEEN '$month[0]' AND '$month[1]') AND shop_order.post_status NOT IN ('trash') ORDER BY total_amount DESC";
		...
		foreach($order_items as $key => $order_item  ) {
			...
			$order_refund_amnt= $it_rpt_main_class->it_get_por_amount_individual($order_item -> order_id,$order_item -> order_item_id,'order');
	...
	$current_month_week_value=($months_weeks_array_value[0]) == 0 ? $it_rpt_main_class->price(0) : $it_rpt_main_class->price($months_weeks_array_value[0]);
	$month_week_3_value= ($months_weeks_array_value[3]) == 0 ? $it_rpt_main_class->price(0) : $it_rpt_main_class->price($months_weeks_array_value[3]);
	$month_week_6_value=($months_weeks_array_value[6]) == 0 ? $it_rpt_main_class->price(0) : $it_rpt_main_class->price($months_weeks_array_value[6]);
	$month_week_12_value=($months_weeks_array_value[12]) == 0 ? $it_rpt_main_class->price(0) : $it_rpt_main_class->price($months_weeks_array_value[12]);
    //////////////////////////////////////////////////////
    ...
    //////////////////////////////////////////////////////
	$sql="SELECT shop_order.ID as order_id,shop_order.post_status, it_woocommerce_order_items.order_item_name	AS 'product_name' ,it_woocommerce_order_items.order_item_id	AS order_item_id ,it_woocommerce_order_itemmeta7.meta_value	AS product_id ,DATE(shop_order.post_date)	AS post_date ,(woocommerce_order_itemmeta.meta_value) AS 'quantity' ,(it_woocommerce_order_itemmeta6.meta_value) AS 'total_amount' FROM {$wpdb->prefix}woocommerce_order_items as it_woocommerce_order_items	LEFT JOIN {$wpdb->prefix}woocommerce_order_itemmeta as woocommerce_order_itemmeta ON woocommerce_order_itemmeta.order_item_id=it_woocommerce_order_items.order_item_id LEFT JOIN {$wpdb->prefix}woocommerce_order_itemmeta as it_woocommerce_order_itemmeta6 ON it_woocommerce_order_itemmeta6.order_item_id=it_woocommerce_order_items.order_item_id LEFT JOIN {$wpdb->prefix}woocommerce_order_itemmeta as it_woocommerce_order_itemmeta7 ON it_woocommerce_order_itemmeta7.order_item_id=it_woocommerce_order_items.order_item_id	LEFT JOIN {$wpdb->prefix}posts as shop_order ON shop_order.id=it_woocommerce_order_items.order_id WHERE 1*1 AND woocommerce_order_itemmeta.meta_key	= '_qty' AND it_woocommerce_order_itemmeta6.meta_key	= '_line_total'	AND (it_woocommerce_order_itemmeta7.meta_key = '_product_id' or it_woocommerce_order_itemmeta7.meta_key = '_variation_id')  AND it_woocommerce_order_itemmeta7.meta_value='$product_id' AND shop_order.post_type	= 'shop_order' AND (DATE(shop_order.post_date) BETWEEN '$it_from_date' AND '$it_to_date') AND shop_order.post_status NOT IN ('trash') group by order_id ORDER BY total_amount DESC";
    ...
    foreach($order_items as $key => $order_item  ) {
	    ...
	    //SALES HISTORY
	    $sale_history_total=($items_total_amunt) == 0 ? $it_rpt_main_class->price(0) : $it_rpt_main_class->price($items_total_amunt);
...
//	    }
	    ...
	    $product_chart_array[$i]['income']= $it_rpt_main_class->price_value($value);
    ...
    $customer_segment_array=array(
        "champions" => esc_html__("CHAMPIONS",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
        "loyal" => esc_html__("LOYAL CUSTOMERS",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
        "potential" => esc_html__("POTENTIAL LOYALIST",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
        "new_customer" => esc_html__("NEW CUSTOMERS",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
        "promising" => esc_html__("PROMISING",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
        "attention" => esc_html__("NEED ATTENTION",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
        "sleep" => esc_html__("ABOUT TO SLEEP",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
        "at_risk" => esc_html__("AT RISK",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
        "no_lose" => esc_html__("CAN'T LOSE THEM",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
        "hibernating" => esc_html__("HIBERNATING",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
        "lose" => esc_html__("LOST",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
        "others" => esc_html__("OTHERS",__IT_REPORT_WCREPORT_TEXTDOMAIN__),
    );
	...
	foreach($customer_array as $email => $customer){
    	...
    	$customer_history_html.='
			<tr class="it_int_customers_single" data-customer-id="'.$customer_id.'" data-customer-email="'.$email.'" data-customer-segment="'.$customer_segment.'">
    ...
    //////////////////////////////////////////////////////
    $this_product_amnt_html=($this_product_amnt) == 0 ? $it_rpt_main_class->price(0) : $it_rpt_main_class->price($this_product_amnt);
    $this_product_amnt_percent=(float)number_format(($this_product_amnt*100)/$total_products_amnt,2 ) ."%";
    $this_product_amnt_percent_html=($this_product_quantity>1) ? "$this_product_quantity ".esc_html__('SALES',__IT_REPORT_WCREPORT_TEXTDOMAIN__).' ' :"$this_product_quantity ".esc_html__('SALE',__IT_REPORT_WCREPORT_TEXTDOMAIN__).' ';

	$this_refund_html=($this_refund_amnt) == 0 ? $it_rpt_main_class->price(0) : $it_rpt_main_class->price($this_refund_amnt);
	...
	$this_product_refund_percent_html=($this_refund_count>1) ? "$this_refund_count ".esc_html__('REFUNDS',__IT_REPORT_WCREPORT_TEXTDOMAIN__).' ' :"$this_refund_count ".esc_html__('REFUND',__IT_REPORT_WCREPORT_TEXTDOMAIN__).' ' ;
    ...
    //REFUNDED EVERY
    $refunded_every_html=esc_html__("No Refunds",__IT_REPORT_WCREPORT_TEXTDOMAIN__);
    $refunded_every=1;
	...
	$avg_price_html=($avg_price) == 0 ? $it_rpt_main_class->price(0) : $it_rpt_main_class->price($avg_price);
    //////////////////////////////////////////////////////
    ...
    $product_sales=($product_sales) == 0 ? $it_rpt_main_class->price(0) : $it_rpt_main_class->price($product_sales);
...
echo '
    <div class="pw-cols col-xs-12 col-md-12">
        <span class="it_rpt_fetch_single_product_back">'.esc_html__('Back to all products',__IT_REPORT_WCREPORT_TEXTDOMAIN__).' |  </span>
        <span class="it_rpt_fetch_single_product_prev"  title="Previous Product">
                <i class="fa fa-angle-left fa-2x"></i>
            </span>
        <span class="it_rpt_fetch_single_product_next" title="Next Product">
            ...
            <div class="pw-card-detail pw-center-align">
                <div class="pw-box-padder">
                    ...
                    <div class="pw-product-subdetail">
                        ...
                        <div class="pw-val pw-sm-font pull-right" title="Product ID: sku-woo">'.esc_html__('SKU:',__IT_REPORT_WCREPORT_TEXTDOMAIN__).' '.$sku.'</div>
                    </div>
                </div>
            </div>
            <div class="pw-card-bottom">
                <div class="pw-box-padder">
                    <span class="pull-left">
                        ...
                        <div class="pw-val pw-xs-font">'.$this_product_amnt_percent_html.'  ('.$this_product_amnt_percent.' '.esc_html__('OF TOTAL',__IT_REPORT_WCREPORT_TEXTDOMAIN__).')</div>
                    </span>
                    <span class="pull-right pw-right-align" >
                        <div class="pw-md-font pw-red">'.$this_refund_html.'</div>
                        <div class="pw-val pw-xs-font">'.$this_product_refund_percent_html.'  ('.$this_product_refund_percent.' '.esc_html__('OF TOTAL',__IT_REPORT_WCREPORT_TEXTDOMAIN__).')</div>
                    </span>
                </div>
                <div class="pw-box-padder">
                    <div id="it_int_single_product_chartdiv"></div>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="pw-border-bottom awr-single-sum">
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="pw-box-padder">
                        ...
                        <div class="pw-val pwl-lbl">'.esc_html__('CURRENT',__IT_REPORT_WCREPORT_TEXTDOMAIN__).' '.$month_week_title.'</div>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="pw-box-padder">
                        ...
                        <div class="pw-val pwl-lbl">3 '.$month_week_titles.' '.esc_html__('AGO',__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</div>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="pw-box-padder">
                        ...
                        <div class="pw-val pwl-lbl">6 '.$month_week_titles.' '.esc_html__('AGO',__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</div>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="pw-box-padder">
                        ...
                        <div class="pw-val pwl-lbl">12 '.$month_week_titles.' '.esc_html__('AGO',__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</div>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="pw-box-padder">
                        ...
                        <div class="pw-val pwl-lbl">'.esc_html__('AVG. PRICE',__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</div>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="pw-box-padder">
                        ...
                        <div class="pw-val pwl-lbl">'.esc_html__('SOLD EVERY',__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</div>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="pw-box-padder">
                        ...
                        <div class="pw-val pwl-lbl">'.esc_html__('TYPICALLY REFUNDED IN',__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</div>
                    </div>
                </div>
            </div>
            <div class="pw-box-padder pw-left-align">
                ...
                <div class="pw-note-cnt">
                    <div class="pw-sm-font">
                        '.esc_html__('NOTE',__IT_REPORT_WCREPORT_TEXTDOMAIN__).'
                    </div>
                    <textarea cols="3" class="pw-sm-font it_intelligence_note_text" placeholder="'.esc_html__('click here to add note for this product ...',__IT_REPORT_WCREPORT_TEXTDOMAIN__).'">'.$note_text.'</textarea>
                    <span class="pw-green it_intelligence_note_resp pw-md-font"></span>
                    <button class="pw-button pw-pull-right it_intelligence_note_text_save" data-id="'.$product_id.'" data-target="product">'.esc_html__('Save',__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</button>
    ...
    <div class="pw-cols col-xs-12 col-md-6">
        <div class="int-awr-box int-fixed-height-box">
            <div class="awr-title">
                <h3>
                    <i class="fa fa-money"></i>'.esc_html__('PEOPLE WHO BOUGHT THIS',__IT_REPORT_WCREPORT_TEXTDOMAIN__).'
                </h3>
            ...
            <div class="int-awr-box-content">
                <div class="pw-box-padder">
					<table class="pw-simple-dashed-tbl pw-sm-font">
                        <tbody>
                            <tr>
                                <th class="pw-left-align pw-black">'.esc_html__('Customers',__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</th>
                                <th class="pw-center-align pw-black">'.esc_html__('Location',__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</th>
                                <th class="pw-center-align pw-black">'.esc_html__('RFM Segment',__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</th>
                                <th class="pw-right-align pw-black">'.esc_html__('Purchased',__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</th>
                            </tr>
                            '.$customer_history_html.'
                        </tbody>
					</table>
    ...
    <div class="pw-cols col-xs-12 col-md-6">
        <div class="int-awr-box int-fixed-height-box">
            <div class="awr-title">
                <h3>
                    <i class="fa fa-money"></i>'.esc_html__('SALES HISTORY',__IT_REPORT_WCREPORT_TEXTDOMAIN__).'
            ...
            <div class="int-awr-box-content">
                <div class="pw-box-padder">
                    <table class="pw-simple-dashed-tbl pw-sm-font">
                        <tbody>
                            <tr>
                                <th class="pw-left-align pw-black">'.esc_html__('Date',__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</th>
                                <th class="pw-center-align pw-black">'.esc_html__('Sales',__IT_REPORT_WCREPORT_TEXTDOMAIN__).' • '.esc_html__('Refunds',__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</th>
                                <th class="pw-right-align pw-black">'.esc_html__('Amount',__IT_REPORT_WCREPORT_TEXTDOMAIN__).'</th>
                            </tr>
                            '.$sale_history_html.'
                        </tbody>
					</table>
...
?>
	<script>
        var it_int_single_product_value=<?php echo json_encode(($product_chart_array)); ?>;
    </script>
