<?php
	...
	if($file_used=="sql_table")
	{
		...
		$it_cur_projected_sales_year= date("Y-m-d");
		$it_cur_projected_sales_year=substr($it_cur_projected_sales_year,0,4);
		...
		$it_to_date			= date("Y-m-d",$end_month_time);
	...
	?>
		<form class='alldetails search_form_report' action='' method='post'>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="awr-form-title">
                        <?php _e('Select Year',__IT_REPORT_WCREPORT_TEXTDOMAIN__);?>
                    </div>
            ...
            <div class="col-md-12 awr-save-form">
                    ...
                    <input type="hidden" name="shop_order_status" id="shop_order_status" value="<?php echo $this->it_shop_status; ?>">
