	...
	?>
		<form class='alldetails search_form_report' action='' method='post'>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="awr-form-title">
			            <?php _e('Order ID(s)',__IT_REPORT_WCREPORT_TEXTDOMAIN__);?>
                    </div>
                    <span class="awr-form-icon"><i class="fa fa-calendar"></i></span>
                    <input name="it_order_ids" id="it_order_ids" type="text" placeholder="<?php _e('Separate ids with coma(,)',__IT_REPORT_WCREPORT_TEXTDOMAIN__);?>"/>
                </div>
