		...
		<form class='alldetails search_form_report' action='' method='post'>
            ...
            <div class="row">
				...
				?>
                    ...
                    <div class="col-md-6"  style=" <?php echo $col_style;?>">
                        <div class="awr-form-title">
                            <?php _e('Tag',__IT_REPORT_WCREPORT_TEXTDOMAIN__);?>
                        </div>
                        <span class="awr-form-icon"><i class="fa fa-tags"></i></span>
                        <?php
                        $args = array(
                ...
                <div class="col-md-6">
                	<div class="awr-form-title">
						<?php _e('Show ',__IT_REPORT_WCREPORT_TEXTDOMAIN__);?>
                    </div>
                    ...
                    <select id="it_adr_show_variations" name="it_show_adr_variaton">
                        <option value="variable" selected><?php _e('Variation Products ',__IT_REPORT_WCREPORT_TEXTDOMAIN__);?></option>
                        <option value="simple" ><?php _e('Simple Products ',__IT_REPORT_WCREPORT_TEXTDOMAIN__);?></option>
                        <option value="-1"><?php _e('All Products ',__IT_REPORT_WCREPORT_TEXTDOMAIN__);?></option>
                    </select>
                ...
                <div class="col-md-6">
                	<div class="awr-form-title">
						<?php _e('Style',__IT_REPORT_WCREPORT_TEXTDOMAIN__);?>
                    </div>
                    ...
                    <select name="it_variation_cols[]" id="it_variation_cols" class="it_variation_cols variation_elements" disabled>
                        <option value="1" selected="selected"><?php _e('Columner',__IT_REPORT_WCREPORT_TEXTDOMAIN__);?></option>
                        <option value="0"><?php _e('Comma Separated',__IT_REPORT_WCREPORT_TEXTDOMAIN__);?></option>
                    </select>
                </div>
                ...
                <div class="col-md-6">
                	<div class="awr-form-title">
						<?php _e('Group By',__IT_REPORT_WCREPORT_TEXTDOMAIN__);?>
                    </div>
                    ...
                    <select name="it_groupby" id="variation_group_by" class="group_by variation_elements" disabled>
                        <option value="variation_id"><?php _e('Variation ID',__IT_REPORT_WCREPORT_TEXTDOMAIN__);?></option>
                        <option value="order_item_id"><?php _e('Order Item ID',__IT_REPORT_WCREPORT_TEXTDOMAIN__);?></option>
                    </select>
                </div>
